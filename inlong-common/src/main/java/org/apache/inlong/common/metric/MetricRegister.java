...
public class MetricRegister {
    ...
    public static void register(MetricItem obj) {
        ...
        beanName.append(JMX_DOMAIN)
                ...
                .append("type=")
                .append(MetricUtils.getDomain(obj.getClass()))
                .append(",")
        ...
        try {
            ...
            LOGGER.error(
                    "exception while register mbean:{},error:{}", strBeanName, ex.getMessage());
    ...
    public static void unregister(MetricItem obj) {
        ...
        try {
            ...
            LOGGER.error(
                    "exception while unregister mbean:{},error:{}", strBeanName, ex.getMessage());
            LOGGER.error(ex.getMessage(), ex);
        }
    }
