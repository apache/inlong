...
public enum MetaField {
    ...
    /**
     * Type of database operation, such as INSERT/DELETE, etc. Currently, it is used for MySQL
     * database.
     */
    OP_TYPE,
    ...
    /**
     * Mapping of sql_type table fields to java data type IDs. Currently, it is used for MySQL
     * database.
     */
    SQL_TYPE,

    /**
     * The current time when the ROW was received and processed. Currently, it is used for MySQL
     * database.
     */
    TS,
