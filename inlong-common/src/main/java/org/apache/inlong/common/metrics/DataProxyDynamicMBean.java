...
public class DataProxyDynamicMBean
    ...
    private final ConcurrentHashMap<String, MetricSnapshot<?>> snapshotAttrs =
            new ConcurrentHashMap<String, MetricSnapshot<?>>();
    ...
    public DataProxyDynamicMBean(String module, String aspect, String desc, MetricsMeta metricsMeta,
            Object source) {
        this.module = module;
        this.aspect = aspect;
        this.desc = desc;
    ...
    private MBeanInfo metricsMetaToInfo() {
        ...
        for (MetricMeta fieldMetricMeta : metricsMeta.getMetricMetaList()) {
            attrs.add(new MBeanAttributeInfo(fieldMetricMeta.getName(), fieldMetricMeta.getType(),
                    fieldMetricMeta.getDesc(), true, false, false));
        }
        return new MBeanInfo(name, description, attrs.toArray(new MBeanAttributeInfo[0]), null,
                null, null);
    }
