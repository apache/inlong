...
import org.apache.inlong.common.metrics.meta.MetricMeta;
import org.apache.inlong.common.metrics.meta.MetricsMeta;
import org.apache.inlong.common.util.MetricUtil;
...
public class MetricsRegister {
    ...
    private static final ConcurrentHashMap<String, ObjectName> CACHED_NAME =
    ...
    private static void innerRegister(DataProxyDynamicMBean agentDynamicMBean) {
        ...
        String nameStr =
                DOMAIN_PREFIX + MODULE_PREFIX + agentDynamicMBean.getModule() + COMMA_SPLITTER
                        + ASPECT_PREFIX + agentDynamicMBean.getAspect();
        try {
    ...
    public static void register(String module, String aspect, String desc, Object source) {
        ...
        if (metricsMeta != null) {
            innerRegister(new DataProxyDynamicMBean(module, aspect, desc, metricsMeta, source));
        } else {
    ...
    private static boolean initFieldByType(Object source, Field field) {
        try {
            ...
            throw new MetricException("Error setting field " + field + " annotated with metric",
                    ex);
        }
    }
    ...
    private static List<MetricMeta> handleFieldAnnotation(Object source) {
        ...
        for (Field field : MetricUtil.getDeclaredFieldsIncludingInherited(source.getClass())) {
