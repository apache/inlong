...
public class TubemqTableSourceSinkFactory
    ...
    public StreamTableSource<Row> createStreamTableSource(
        ...
        final Optional<String> proctimeAttribute = SchemaValidator.deriveProctimeAttribute(descriptorProperties);
        final List<RowtimeAttributeDescriptor> rowtimeAttributeDescriptors = SchemaValidator
                .deriveRowtimeAttributes(descriptorProperties);
        ...
        final String topic = descriptorProperties.getString(TubemqValidator.CONNECTOR_TOPIC);
        final String masterAddress = descriptorProperties.getString(TubemqValidator.CONNECTOR_MASTER);
        final String consumerGroup = descriptorProperties.getString(TubemqValidator.CONNECTOR_GROUP);
        final String tids = descriptorProperties
                .getOptionalString(TubemqValidator.CONNECTOR_TIDS)
                .orElse(null);
        final Configuration configuration = getConfiguration(descriptorProperties);
