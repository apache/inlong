...
public class TubemqTableSink implements AppendStreamTableSink<Row> {
    ...
    public TubemqTableSink(
        ...
        this.serializationSchema =
                checkNotNull(serializationSchema, "The deserialization schema must not be null.");
        this.schema = checkNotNull(schema, "The schema must not be null.");
        this.topic = checkNotNull(topic, "Topic must not be null.");
        this.masterAddress = checkNotNull(masterAddress, "Master address must not be null.");
    ...
    public DataStreamSink<?> consumeDataStream(DataStream<Row> dataStream) {
        ...
        final SinkFunction<Row> tubemqSinkFunction =
                new TubemqSinkFunction<>(topic, masterAddress, serializationSchema, configuration);
