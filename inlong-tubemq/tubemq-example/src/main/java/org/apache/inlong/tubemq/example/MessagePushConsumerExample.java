 ...
 *
 * Consumer supports subscribe multiple topics in one consume group. Message
 * from subscription sent back to business logic via callback
 * {@link MessageListener}. It is highly recommended NOT to perform any blocking
 * operation inside the callback.
 *
 * As for consumption control of {@link PushMessageConsumer}, business logic is
 * able to monitor current state and adjust consumption by
 *
 * <ul>
 * <li>call {@link PushMessageConsumer#pauseConsume()} to pause consumption when
 * high water mark exceeded.</li>
 * <li>call {@link PushMessageConsumer#resumeConsume()} to resume
 * consumption</li>
 * </ul>
 */
public final class MessagePushConsumerExample {
     ...
     *          clientCount is the amount of consumer; The 5th parameter
     *          fetchThreadCnt is the count of fetch thread.
     */
    ...
    // After the SDK receives the message, it will pass the message back to the
    // business layer
