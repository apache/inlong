 ...
 * sent back to business logic via callback {@link MessageListener}. It is highly recommended NOT to
 * perform any blocking operation inside the callback.
 *
 ...
 *
 * <ul>
 *   <li>call {@link PushMessageConsumer#pauseConsume()} to pause consumption when high water mark
 *       exceeded.
 *   <li>call {@link PushMessageConsumer#resumeConsume()} to resume consumption
 * </ul>
 */
public final class MessagePushConsumerExample {
     ...
     *     name of consumer group; The 4th parameter clientCount is the amount of consumer; The 5th
     *     parameter fetchThreadCnt is the count of fetch thread.
     */
