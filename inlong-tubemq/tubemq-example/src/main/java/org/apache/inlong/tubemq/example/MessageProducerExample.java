 ...
 *
 * <p>Producer supports publish one or more topics via {@link MessageProducer#publish(String)} or
 * {@link MessageProducer#publish(Set)}. Note that topic publish asynchronously.
 */
