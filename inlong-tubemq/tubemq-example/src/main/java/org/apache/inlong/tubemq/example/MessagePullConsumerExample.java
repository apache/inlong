...
/**
 * This demo shows how to consume messages through TubeSingleSessionFactory +
 * PullMessageConsumer
 *
 * Consume message in pull mode achieved by
 * {@link PullMessageConsumer#getMessage()}. Note that whenever
 * {@link PullMessageConsumer#getMessage()} returns successfully, the return
 * value(whether or not to be {@code null}) must be processed by
...
public final class MessagePullConsumerExample {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        // we can construct multiple consumers after the creation of the session factory
        // object
