...
public final class RpcConstants {
    ...
    public static final int MAX_FRAME_MAX_LIST_SIZE = (int) ((TBaseConstants.META_MAX_MESSAGE_DATA_SIZE_UPPER_LIMIT
    ...
    public static final int CFG_DEFAULT_CLIENT_WORKER_COUNT = Runtime.getRuntime().availableProcessors() + 1;
    public static final int CFG_DEFAULT_SERVER_WORKER_COUNT = Runtime.getRuntime().availableProcessors() * 2;
