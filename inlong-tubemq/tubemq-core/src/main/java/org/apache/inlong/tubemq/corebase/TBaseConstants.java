...
public class TBaseConstants {
    ...
    public static final int META_MAX_MESSAGE_DATA_SIZE = META_MIN_ALLOWED_MESSAGE_SIZE_MB * META_MB_UNIT_SIZE;
    public static final int META_MIN_MEM_BUFFER_SIZE = META_MAX_MESSAGE_DATA_SIZE + META_MESSAGE_SIZE_ADJUST;
