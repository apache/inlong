...
public class TLSConfig {
    ...
    public String toString() {
        return new StringBuilder(512)
                .append("\"TLSConfig\":{\"tlsEnable\":")
                .append(tlsEnable)
                .append(",\"tlsPort\":")
                .append(tlsPort)
                .append(",\"tlsTrustStorePath\":\"")
                .append(tlsTrustStorePath)
                .append("\",\"tlsTrustStorePassword\":\"")
                .append(tlsTrustStorePassword)
                .append("\",\"tlsTwoWayAuthEnable\":")
                .append(tlsTwoWayAuthEnable)
                .append(",\"tlsKeyStorePath\":\"")
                .append(tlsKeyStorePath)
                .append("\",\"tlsKeyStorePassword\":\"")
                .append(tlsKeyStorePassword)
                .append("\"}")
                .toString();
    }
