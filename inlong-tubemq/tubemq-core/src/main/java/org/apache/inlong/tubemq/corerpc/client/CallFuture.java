...
public class CallFuture<T> implements Future<T>, Callback<T> {
     ...
     * {@link #get(long, java.util.concurrent.TimeUnit)} is usually preferred
     * because these methods block until the result is available or an error occurs.
     *
     ...
     * {@link #get()} or {@link #get(long, java.util.concurrent.TimeUnit)} should be
     * called first because these methods block until the RPC has completed.
     *
