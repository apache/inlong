 ...
 *
 * <p>Currently includes the total number of messages and bytes according to the statistics
 * dimension, which can be expanded later as needed
 */
public class TrafficStatsUnit {
    ...
    public void getValue(StringBuilder strBuff, boolean resetValue) {
        ...
        if (resetValue) {
            strBuff.append("{\"")
                    .append(msgCnt.getShortName())
                    .append("\":")
                    .append(msgCnt.getAndResetValue())
                    .append(",\"")
                    .append(msgSize.getShortName())
                    .append("\":")
                    .append(msgSize.getAndResetValue())
                    .append("}");
        } else {
            strBuff.append("{\"")
                    .append(msgCnt.getShortName())
                    .append("\":")
                    .append(msgCnt.getValue())
                    .append(",\"")
                    .append(msgSize.getShortName())
                    .append("\":")
                    .append(msgSize.getValue())
                    .append("}");
        }
    }
}
