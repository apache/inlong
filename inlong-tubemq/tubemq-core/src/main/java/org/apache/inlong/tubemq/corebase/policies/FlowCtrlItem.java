...
public class FlowCtrlItem {
    ...
    private int type =
            0; // 0: current limit, 1: frequency limit, 2: SSD transfer 3: request frequency control
    ...
    public FlowCtrlItem(
            int type, int startTime, int endTime, long dltInM, long dataLtInSZ, int freqLtInMs) {
        this.type = type;
    ...
    public FlowCtrlItem(
            int type, int normFreqLtInMs, int filterFreqInMs, int minDataFilterFreqInMs) {
        this.type = type;
    ...
    public StringBuilder toJsonString(final StringBuilder sBuilder) {
        switch (this.type) {
            case 1:
                return sBuilder.append("{\"zeroCnt\":")
                        .append(this.zeroCnt)
                        .append(",\"freqInMs\":")
                        .append(this.freqLtInMs)
                        .append("}");
            case 2:
                return sBuilder.append("{\"start\":\"")
                        ...
                        .append(String.format("%02d", this.endTime % 100))
                        .append("\",\"dltStInM\":")
                        .append(this.dltInM / 1024 / 1024)
                        .append(",\"dltEdInM\":")
                        .append(this.dataLtInSZ / 1024 / 1024)
                        .append("}");
            case 3:
                return sBuilder.append("{\"normFreqInMs\":")
                        .append((int) this.dataLtInSZ)
                        .append(",\"filterFreqInMs\":")
                        .append(this.freqLtInMs)
                        .append(",\"minDataFilterFreqInMs\":")
                        .append(this.zeroCnt)
                        .append("}");
            case 0:
            default:
