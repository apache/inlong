...
/**
 * MetricMXBean Broker's metric data access interface, including: the getValue() that directly
 * obtains data the snapshot() that can clear the values of the counter, maximum and minimum
 * extremum Gauge data
 */
