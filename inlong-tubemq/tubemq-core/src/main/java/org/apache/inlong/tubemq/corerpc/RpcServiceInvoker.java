...
public class RpcServiceInvoker extends AbstractServiceInvoker {
    ...
    public RpcServiceInvoker(
            ClientFactory clientFactory,
            Class serviceClass,
            RpcConfig conf,
            NodeAddrInfo targetAddress) {
    ...
    public Object callMethod(String targetInterface, String method, Object arg, Callback callback)
        ...
        ResponseWrapper responseWrapper =
                client.call(requestWrapper, callback, requestTimeout, TimeUnit.MILLISECONDS);
        if (responseWrapper != null) {
            if (responseWrapper.isSuccess()) {
                return responseWrapper.getResponseData();
            } else {
                throw MixUtils.unwrapException(
