 ...
 *
 * <p>The metric includes a base name and a prefix, the full name is composed of the prefix + "_" +
 * the base name, different name are selected for output according to the metric output
 * requirements.
 */
