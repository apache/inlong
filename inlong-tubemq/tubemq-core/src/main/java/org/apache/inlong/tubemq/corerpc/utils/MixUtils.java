...
public class MixUtils {
     ...
     *
     * <p>After TubeMQ was donated to Apache, the package prefix name was not migrated to the name
     * of apache for a long time, and some errors on the server side were returned to the client by
     * throwing exceptions. In order to maintain the compatibility between the previous and previous
     * versions, the the class name in exception information is replaced through this function
     *
     ...
     */
    public static String replaceClassNamePrefix(
            String className, boolean toOldVersion, int toProtocolVer) {
                    ...
                    if (clazz != null) {
                        ...
                        if (ctor != null) {
                            if (strExceptionMsgSet.length == 1) {
                                ...
                                if (strExceptionMsgSet[0].equalsIgnoreCase(
