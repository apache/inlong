...
public interface BrokerWriteService {
    ...
    ClientBroker.SendMessageResponseB2P sendMessageP2B(
            ClientBroker.SendMessageRequestP2B request, String rmtAddress, boolean overtls)
            throws Throwable;

    interface AsyncService extends BrokerWriteService {

        void sendMessageP2B(
                ClientBroker.SendMessageRequestP2B request,
                String rmtAddress,
                boolean overtls,
                Callback callback)
                throws Throwable;
