 ...
 *
 * <p>This class includes the date and time-related methods, for unified use and management.
 */
public class DateTimeConvertUtils {
    ...
    /**
     * Converts the specified timestamp value to a string in the format yyyyMMddHHmm under the
    ...
    /**
     * Converts the time string in yyyyMMddHHmm format to timestamp value under the current system
     * default time zone
     *
    ...
    /**
     * Converts the time string in yyyyMMddHHmm format to timestamp value under the specified time
     * zone
     *
     * @param yyyyMMddHHmm the time string in yyyyMMddHHmm format
     * @param zoneId the specified time zone
    ...
    /**
     * Converts the specified timestamp value to a string in the format yyyyMMddHHmmss under the
     * current system default time zone
     *
     * @param timestamp The millisecond value of the specified time
    ...
    /**
     * Converts the time string in yyyyMMddHHmmss format to timestamp value under the current system
     * default time zone
     *
    ...
    /**
     * Converts the time string in yyyyMMddHHmmss format to timestamp value under the specified time
     * zone
     *
     * @param yyyyMMddHHmmss the time string in yyyyMMddHHmmss format
     * @param zoneId the specified time zone
    ...
    /**
     * Converts the time string in yyyyMMddHHmmss format to date value under the specified time zone
     *
     * @param yyyyMMddHHmmss the time string in yyyyMMddHHmmss format
