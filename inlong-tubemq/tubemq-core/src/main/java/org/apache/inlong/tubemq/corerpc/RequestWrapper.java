...
public class RequestWrapper implements Serializable {
    ...
    public RequestWrapper(int serviceType, int protocolVersion, int flagId, long timeout) {
    ...
    public RequestWrapper(
            int serviceType, int protocolType, int protocolVersion, int flagId, long timeout) {
        this.serviceType = serviceType;
