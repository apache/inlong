 ...
 *
 * <p>The {@link ZooKeeperWatcher} for a process will execute the appropriate methods of
 ...
 *
 * <p>Subclasses need only override those methods in which they are interested.
 *
 * <p>Note that the watcher will be blocked when invoking methods in listeners so they must not be
 * long-running.
 *
