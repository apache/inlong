...
public class WebParameterUtils {
    ...
    public static StringBuilder buildFailResultWithBlankData(
            int errcode, String errMsg, StringBuilder sBuffer) {
        return sBuffer.append("{\"result\":false,\"errCode\":")
                .append(errcode)
                .append(",\"errMsg\":\"")
                .append(errMsg)
                .append("\",\"data\":[]}");
    ...
    public static StringBuilder buildSuccessWithDataRetEnd(StringBuilder sBuffer, int totalCnt) {
     ...
     * @param defOpEntity default value set, if not null, it must fill required field values
     * @param sBuffer string buffer
     * @param result process result of parameter value
     * @return the process result
     */
    public static <T> boolean getAUDBaseInfo(
            T paramCntr,
            boolean isAdd,
        ...
        if (!WebParameterUtils.getLongParamValue(
                paramCntr,
        ...
        if (isAdd) {
            ...
            if (!WebParameterUtils.getDateParameter(
                    paramCntr,
                    WebFieldDef.CREATEDATE,
                    false,
        ...
        result.setSuccResult(
                new BaseEntity(dataVerId, createUsr, createDate, modifyUser, modifyDate));
        return result.isSuccess();
    }
     ...
     */
    public static boolean getQueriedOperateInfo(
        ...
        if (!WebParameterUtils.getStringParamValue(
                req, WebFieldDef.CREATEUSER, false, null, sBuffer, result)) {
            return result.isSuccess();
        }
        String createUser = (String) result.getRetData();
        // check modify user field
        if (!WebParameterUtils.getStringParamValue(
                req, WebFieldDef.MODIFYUSER, false, null, sBuffer, result)) {
            return result.isSuccess();
        }
        String modifyUser = (String) result.getRetData();
        // set query keys
    ...
    public static <T> boolean getQryPriorityIdParameter(
            T paramCntr,
            boolean required,
            int defValue,
            int minValue,
    ...
    /**
     * Decode the deletePolicy parameter value from an object value the value must like
     * {method},{digital}[s|m|h]
     *
     * @param paramCntr parameter container object
     ...
     * @return the process result
     */
    public static <T> boolean getDeletePolicyParameter(
            T paramCntr,
            boolean required,
            String defValue,
            StringBuilder sBuffer,
            ProcessResult result) {
        if (!WebParameterUtils.getStringParamValue(
                paramCntr, WebFieldDef.DELETEPOLICY, required, defValue, sBuffer, result)) {
            return result.isSuccess();
        }
        ...
        if (tmpStrs.length != 2) {
            result.setFailResult(
                    ...
                    sBuffer.append("Value must include one and only one comma character,")
                            ...
                            .append(" must like {method},{digital}[m|s|h]")
                            .toString());
            sBuffer.delete(0, sBuffer.length());
            return result.isSuccess();
        }
        ...
        if (!"delete".equalsIgnoreCase(tmpStrs[0].trim())) {
            result.setFailResult(
                    ...
                    sBuffer.append("Field ")
                            .append(WebFieldDef.DELETEPOLICY.name())
                            .append(" only support delete method now!")
                            .toString());
            sBuffer.delete(0, sBuffer.length());
            return result.isSuccess();
        }
        ...
        if (Character.isLetter(timeUnit.charAt(0))) {
            if (!allowedDelUnits.contains(timeUnit)) {
                result.setFailResult(
                        ...
                        sBuffer.append("Field ")
                                .append(WebFieldDef.DELETEPOLICY.name())
                                .append(" only support [s|m|h] unit!")
                                .toString());
                sBuffer.delete(0, sBuffer.length());
                return result.isSuccess();
            }
        ...
        try {
            if (timeUnit.endsWith("s")) {
                ...
                validDuration =
                        Long.parseLong(validValStr.substring(0, validValStr.length() - 1))
                                * 3600000;
            } else {
            ...
            result.setFailResult(
                    ...
                    sBuffer.append("The value of field ")
                            .append(WebFieldDef.DELETEPOLICY.name())
                            .append("'s valid duration must digits!")
                            .toString());
            sBuffer.delete(0, sBuffer.length());
            return result.isSuccess();
        }
        ...
        if (Character.isLetter(timeUnit.charAt(0))) {
            ...
            result.setSuccResult(
                    sBuffer.append("delete,").append(validValStr).append("h").toString());
        }
        sBuffer.delete(0, sBuffer.length());
        return result.isSuccess();
    }
     ...
     * @return the process result
     */
    public static boolean getTopicStatusParamValue(
            HttpServletRequest req,
            boolean isRequired,
            TopicStatus defVal,
            StringBuilder sBuffer,
        ...
        if (!WebParameterUtils.getIntParamValue(
                req,
                WebFieldDef.TOPICSTATUSID,
                isRequired,
                defVal.getCode(),
                TopicStatus.STATUS_TOPIC_UNDEFINED.getCode(),
                sBuffer,
                result)) {
            return result.isSuccess();
        }
     ...
     */
    public static boolean isValidPortsSet(
            int brokerPort,
            int brokerTlsPort,
            int brokerWebPort,
     ...
     * @return process result
     */
    public static <T> boolean getTopicPropInfo(
            T paramCntr, TopicPropGroup defVal, StringBuilder sBuffer, ProcessResult result) {
        ...
        if (!WebParameterUtils.getIntParamValue(
                ...
                TServerConstants.TOPIC_STOREBLOCK_NUM_MIN,
                sBuffer,
                result)) {
            return result.isSuccess();
        }
        ...
        if (!WebParameterUtils.getIntParamValue(
                ...
                (defVal == null
                        ? TBaseConstants.META_VALUE_UNDEFINED
                        : defVal.getUnflushThreshold()),
                TServerConstants.TOPIC_DSK_UNFLUSHTHRESHOLD_MIN,
                sBuffer,
                result)) {
            return result.isSuccess();
        }
        ...
        if (!WebParameterUtils.getIntParamValue(
                ...
                (defVal == null
                        ? TBaseConstants.META_VALUE_UNDEFINED
                        : defVal.getUnflushInterval()),
                TServerConstants.TOPIC_DSK_UNFLUSHINTERVAL_MIN,
                sBuffer,
                result)) {
            return result.isSuccess();
        }
        ...
        if (!WebParameterUtils.getIntParamValue(
                ...
                (defVal == null
                        ? TBaseConstants.META_VALUE_UNDEFINED
                        : defVal.getMemCacheMsgSizeInMB()),
                TServerConstants.TOPIC_CACHESIZE_MB_MIN,
                TServerConstants.TOPIC_CACHESIZE_MB_MAX,
                sBuffer,
                result)) {
            return result.isSuccess();
        }
        ...
        if (!WebParameterUtils.getIntParamValue(
                ...
                (defVal == null
                        ? TBaseConstants.META_VALUE_UNDEFINED
                        : defVal.getMemCacheFlushIntvl()),
                TServerConstants.TOPIC_CACHEINTVL_MIN,
                sBuffer,
                result)) {
            return result.isSuccess();
        }
        ...
        if (!WebParameterUtils.getIntParamValue(
                ...
                (defVal == null
                        ? TBaseConstants.META_VALUE_UNDEFINED
                        : defVal.getMemCacheMsgCntInK()),
                TServerConstants.TOPIC_CACHECNT_INK_MIN,
                sBuffer,
                result)) {
            return result.isSuccess();
        }
        ...
        if (!WebParameterUtils.getDeletePolicyParameter(
                paramCntr,
                false,
                (defVal == null ? null : defVal.getDeletePolicy()),
                sBuffer,
                result)) {
            return result.isSuccess();
        }
        ...
        if (!WebParameterUtils.getBooleanParamValue(
                ...
                false,
                (defVal == null ? null : defVal.getAcceptPublish()),
                sBuffer,
                result)) {
            return result.isSuccess();
        }
        ...
        if (!WebParameterUtils.getBooleanParamValue(
                paramCntr,
                WebFieldDef.ACCEPTSUBSCRIBE,
                false,
                (defVal == null ? null : defVal.getAcceptSubscribe()),
                sBuffer,
                result)) {
            return result.isSuccess();
        }
     ...
     * @return process result
     */
    public static <T> boolean getLongParamValue(
            T paramCntr,
            ...
            StringBuilder sBuffer,
            ProcessResult result) {
        if (!getStringParamValue(paramCntr, fieldDef, required, null, sBuffer, result)) {
            return result.isSuccess();
        }
     ...
     * @return process result
     */
    public static <T> boolean getFlowCtrlStatusParamValue(
            T paramCntr,
            boolean required,
            Boolean defValue,
            StringBuilder sBuffer,
     ...
     * @return process result
     */
    public static <T> boolean getIntParamValue(
            T paramCntr,
            WebFieldDef fieldDef,
            boolean required,
            StringBuilder sBuffer,
            ProcessResult result) {
        return getIntParamValue(
                paramCntr,
                fieldDef,
                required,
                false,
    ...
    public static <T> boolean getIntParamValue(
            ...
            ProcessResult result) {
        return getIntParamValue(
                paramCntr, fieldDef, required, true, defValue, true, minValue, true, maxValue,
                sBuffer, result);
    }

    // get int value from parameter string value
    private static <T> boolean getIntParamValue(
            T paramCntr,
            WebFieldDef fieldDef,
            boolean required,
            boolean hasDefVal,
        ...
        if (fieldDef.isCompFieldType()) {
            ...
            for (String itemVal : valItemSet) {
                if (!checkIntValueNorms(
                        fieldDef, itemVal, hasMinVal, minValue, hasMaxVal, maxValue, sBuffer,
                        result)) {
                    return result.isSuccess();
                }
     ...
     */
    public static <T> boolean getBooleanParamValue(
            T paramCntr,
            WebFieldDef fieldDef,
            boolean required,
            Boolean defValue,
     ...
     * @return valid result for the parameter value
     */
    public static <T> boolean getStringParamValue(
            T paramCntr,
            WebFieldDef fieldDef,
            boolean required,
            String defValue,
        ...
        if (paramCntr instanceof Map) {
            Map<String, String> keyValueMap = (Map<String, String>) paramCntr;
        ...
        return checkStrParamValue(paramValue, fieldDef, required, defValue, sBuffer, result);
    }
     ...
     * @return valid result for the parameter value
     */
    private static boolean checkStrParamValue(
            String paramValue,
            WebFieldDef fieldDef,
            boolean required,
            String defValue,
        ...
        if (TStringUtils.isBlank(paramValue)) {
            if (required) {
                result.setFailResult(
                        sBuffer.append("Parameter ")
                                .append(fieldDef.name)
                                .append(" is missing or value is blank!")
                                .toString());
                sBuffer.delete(0, sBuffer.length());
            } else {
     ...
     * @return process result
     */
    public static boolean getAndValidTopicNameInfo(
            HttpServletRequest req,
            ...
            ProcessResult result) {
        if (!WebParameterUtils.getStringParamValue(
                req, WebFieldDef.COMPSTOPICNAME, required, defValue, sBuffer, result)) {
            return result.isSuccess();
        }
        ...
        for (String topic : topicNameSet) {
            if (!existedTopicSet.contains(topic)) {
                result.setFailResult(
                        sBuffer.append(WebFieldDef.COMPSTOPICNAME.name)
                                .append(" value ")
                                .append(topic)
                                .append(" is not configure, please configure first!")
                                .toString());
                sBuffer.delete(0, sBuffer.length());
                break;
            }
     ...
     * @return process result
     */
    public static <T> boolean getFilterCondString(
            T paramCntr,
            boolean required,
            boolean transBlank,
            StringBuilder sBuffer,
     ...
     * @return process result
     */
    public static <T> boolean getFilterCondSet(
            T paramCntr,
            boolean required,
            ...
            ProcessResult result) {
        if (!WebParameterUtils.getStringParamValue(
                paramCntr, WebFieldDef.FILTERCONDS, required, null, sBuffer, result)) {
            return result.isSuccess();
        }
        if (transCondItem) {
     ...
     * @return valid result for the parameter value
     */
    public static boolean getJsonDictParamValue(
            HttpServletRequest req,
            WebFieldDef fieldDef,
            boolean required,
        ...
        try {
            paramValue = URLDecoder.decode(paramValue, TBaseConstants.META_DEFAULT_CHARSET_NAME);
        ...
        try {
            Map<String, Long> manOffsets =
                    new Gson()
                            .fromJson(paramValue, new TypeToken<Map<String, Long>>() {}.getType());
     ...
     * @return valid result for the parameter value
     */
    public static boolean getJsonArrayParamValue(
            HttpServletRequest req,
            WebFieldDef fieldDef,
            boolean required,
        ...
        // parse data
        try {
            List<Map<String, String>> arrayValue =
                    new Gson()
                            .fromJson(
                                    paramValue,
     ...
     * @return valid result for the parameter value
     */
    public static <T> boolean getDateParameter(
            T paramCntr,
            WebFieldDef fieldDef,
            boolean required,
            Date defValue,
        ...
        if (date == null) {
            result.setFailResult(
                    sBuffer.append("Parameter ")
                            ...
                            .append(DateTimeConvertUtils.PAT_YYYYMMDDHHMMSS)
                            .toString());
            sBuffer.delete(0, sBuffer.length());
        } else {
     ...
     * @return valid result for the parameter value
     */
    public static boolean validReqAuthorizeInfo(
            HttpServletRequest req,
            boolean required,
            TMaster master,
            StringBuilder sBuffer,
        ...
        if (!getStringParamValue(
                req, WebFieldDef.ADMINAUTHTOKEN, required, null, sBuffer, result)) {
            return result.isSuccess();
        }
        String paramValue = (String) result.getRetData();
        if (paramValue != null) {
     ...
     */
    private static boolean procStringDefValue(
            boolean isCompFieldType, String defValue, ProcessResult result) {
        if (isCompFieldType) {
            TreeSet<String> valItemSet = new TreeSet<>();
     ...
     */
    private static boolean checkStrValueNorms(
            WebFieldDef fieldDef, String paramVal, StringBuilder sBuffer, ProcessResult result) {
        ...
        if (fieldDef.valMaxLen != TBaseConstants.META_VALUE_UNDEFINED) {
            if (paramVal.length() > fieldDef.valMaxLen) {
                result.setFailResult(
                        sBuffer.append("over max length for ")
                                .append(fieldDef.name)
                                .append(", only allow ")
                                .append(fieldDef.valMaxLen)
                                .append(" length")
        ...
        if (fieldDef.regexCheck) {
            if (!paramVal.matches(fieldDef.regexDef.getPattern())) {
                if ((fieldDef != WebFieldDef.TOPICNAME && fieldDef != WebFieldDef.COMPSTOPICNAME)
                        || !paramVal.equals(TServerConstants.OFFSET_HISTORY_NAME)) {
                    result.setFailResult(
                            sBuffer.append("illegal value for ")
                                    .append(fieldDef.name)
                                    .append(", value ")
                                    .append(fieldDef.regexDef.getErrMsgTemp())
                                    .toString());
                    sBuffer.delete(0, sBuffer.length());
                    return false;
                }
     ...
     * @return check result for string value of parameter
     */
    private static boolean checkIntValueNorms(
            WebFieldDef fieldDef,
            String paramValue,
            boolean hasMinVal,
            int minValue,
     ...
     */
    public static String checkAndGetFilterConds(
            String inFilterConds, boolean isTransBlank, StringBuilder sb) throws Exception {
        ...
        if (TStringUtils.isBlank(inFilterConds)) {
            ...
            for (int i = 0; i < strFilterConds.length; i++) {
                ...
                if (filterCond.length() > TBaseConstants.CFG_FLT_MAX_FILTER_ITEM_LENGTH) {
                    ...
                    throw new Exception(
                            sb.append("Illegal value: the max length of ")
                                    .append(filterCond)
                                    .append(" in filterConds parameter over ")
                ...
                if (!filterCond.matches(TBaseConstants.META_TMP_FILTER_VALUE)) {
                    sb.delete(0, sb.length());
                    throw new Exception(
                            sb.append("Illegal value: the value of ")
                                    .append(filterCond)
                                    .append(" in filterCond parameter ")
                                    .append("must only contain characters,numbers,and underscores")
                                    .toString());
                }
     ...
     * @throws Exception if failed to decode the filter conditions
     */
    public static Set<String> checkAndGetFilterCondSet(
            String inFilterConds, boolean transCondItem, boolean checkTotalCnt, StringBuilder sb)
            throws Exception {
        ...
        if (TStringUtils.isNotBlank(inFilterConds)) {
            ...
            for (int i = 0; i < strFilterConds.length; i++) {
                ...
                if (!filterCond.matches(TBaseConstants.META_TMP_FILTER_VALUE)) {
                    ...
                    throw new Exception(
                            sb.append("Illegal value: the value of ")
                                    .append(filterCond)
                                    .append(" in filterCond parameter must ")
                                    .append("only contain characters,numbers,and underscores")
                                    .toString());
                }
                if (transCondItem) {
                    filterCondSet.add(
            ...
            if (checkTotalCnt) {
                if (filterCondSet.size() > TBaseConstants.CFG_FLT_MAX_FILTER_ITEM_COUNT) {
                    throw new Exception(
                            sb.append("Illegal value: the count of filterCond's ")
     ...
     */
    public static Set<String> getBatchGroupNames(
        ...
        if (strGroupNames.length > TServerConstants.CFG_BATCH_RECORD_OPERATE_MAX_COUNT) {
            throw new Exception(
                    sb.append("Illegal value: groupName's batch count over max count ")
                            .append(TServerConstants.CFG_BATCH_RECORD_OPERATE_MAX_COUNT)
                            .toString());
        }
        for (int i = 0; i < strGroupNames.length; i++) {
            ...
            if (checkResToken) {
                if (resTokens != null && !resTokens.isEmpty()) {
                    if (resTokens.contains(groupName)) {
                        throw new Exception(
                                sb.append("Illegal value: in groupName parameter, '")
                                        .append(groupName)
                                        .append("' is a system reserved token!")
                                        .toString());
                    }
                }
            }
            if (groupName.length() > TBaseConstants.META_MAX_GROUPNAME_LENGTH) {
                throw new Exception(
                        sb.append("Illegal value: the max length of ")
                                .append(groupName)
                                .append(" in groupName parameter over ")
            ...
            if (!groupName.matches(TBaseConstants.META_TMP_GROUP_VALUE)) {
                throw new Exception(
                        sb.append("Illegal value: the value of ")
                                .append(groupName)
                                .append(
                                        "in groupName parameter must begin with a letter, can only contain ")
                                .append("characters,numbers,hyphen,and underscores")
                                .toString());
            }
     ...
     */
    public static Set<String> getBatchBrokerIpSet(String inStrBrokerIps, boolean checkEmpty)
            throws Exception {
        ...
        for (int i = 0; i < strBrokerIps.length; i++) {
            ...
            String brokerIp = checkParamCommonRequires("brokerIp", strBrokerIps[i], true);
     ...
     * @throws Exception
     */
    public static List<Map<String, String>> checkAndGetJsonArray(
            String paramName, String paramValue, int paramMaxLen, boolean required)
            throws Exception {
        ...
        try {
            decTmpParamVal =
                    URLDecoder.decode(tmpParamValue, TBaseConstants.META_DEFAULT_CHARSET_NAME);
        } catch (UnsupportedEncodingException e) {
            throw new Exception(
                    new StringBuilder(512)
                            .append("Decode ")
        ...
        return new Gson()
                .fromJson(decTmpParamVal, new TypeToken<List<Map<String, String>>>() {}.getType());
    }
    ...
    public static boolean checkBrokerInOnlineStatus(BdbBrokerConfEntity curEntity) {
        if (curEntity != null) {
            return (curEntity.getManageStatus() == TStatusConstants.STATUS_MANAGE_ONLINE
                    || curEntity.getManageStatus()
                            == TStatusConstants.STATUS_MANAGE_ONLINE_NOT_WRITE
                    || curEntity.getManageStatus()
     ...
     */
    public static String checkParamCommonRequires(
            String paramName, String paramValue, boolean required) throws Exception {
     ...
     */
    public static <T> int getAndCheckFlowRules(
            T paramCntr, String defValue, StringBuilder sBuffer, ProcessResult result) {
        // get parameter value
        String paramValue;
        // get parameter value
        if (paramCntr instanceof Map) {
    ...
    private static int validFlowRuleValue(
            String paramValue, StringBuilder sBuffer, ProcessResult result) {
        int ruleCnt = 0;
        paramValue = paramValue.trim();
        ...
        try {
            ...
            result.setFailResult(
                    sBuffer.append("Parse parameter ")
