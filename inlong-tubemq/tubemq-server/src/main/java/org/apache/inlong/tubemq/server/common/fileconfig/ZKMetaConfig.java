...
public class ZKMetaConfig extends ZKConfig {
    ...
    public String toString() {
        return new StringBuilder(512)
                .append("\"ZKMetaConfig\":{\"zkServerAddr\":\"")
                .append(getZkServerAddr())
                .append("\",\"zkNodeRoot\":\"")
                .append(getZkNodeRoot())
                .append("\",\"zkSessionTimeoutMs\":")
                .append(getZkSessionTimeoutMs())
                .append(",\"zkConnectionTimeoutMs\":")
                .append(getZkConnectionTimeoutMs())
                .append(",\"zkSyncTimeMs\":")
                .append(getZkSyncTimeMs())
                .append(",\"zkCommitPeriodMs\":")
                .append(getZkCommitPeriodMs())
                .append(",\"zkCommitFailRetries\":")
                .append(getZkCommitFailRetries())
