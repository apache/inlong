...
public class WebAdminFlowRuleHandler extends AbstractWebHandler {
    ...
    public void registerWebApiMethod() {
        ...
        registerQueryWebMethod(
                "admin_query_group_flow_control_rule", "adminQueryGroupFlowCtrlRule");
     ...
     */
    public StringBuilder adminQueryGroupFlowCtrlRule(
     ...
     * @return process result
     */
    public StringBuilder adminSetGroupFlowCtrlRule(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result) {
     ...
     * @return process result
     */
    public StringBuilder adminUpdGroupFlowCtrlRule(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result) {
        ...
        for (String groupName : groupNameSet) {
            retInfoList.add(
                    defMetaDataService.insertGroupCtrlConf(
                            opEntity,
                            groupName,
                            TServerConstants.QRY_PRIORITY_DEF_VALUE,
                            Boolean.FALSE,
                            0,
     ...
     * @return process result
     */
    private StringBuilder innAddOrUpdGroupFlowCtrlRule(
