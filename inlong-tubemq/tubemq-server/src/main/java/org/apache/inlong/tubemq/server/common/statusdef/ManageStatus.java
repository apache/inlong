...
public enum ManageStatus {
    ...
    ManageStatus(int code, String description, boolean acceptPublish, boolean acceptSubscribe) {
        this.code = code;
    ...
    public static ManageStatus valueOf(int code) {
        ...
        throw new IllegalArgumentException(
                String.format("unknown broker manage status code %s", code));
    }
    ...
    public static ManageStatus descOf(String description) {
        ...
        throw new IllegalArgumentException(
                String.format("unknown broker manage status name %s", description));
    }
     ...
     */
    public static ManageStatus getNewStatus(
            ManageStatus oldStatus, Boolean acceptPublish, Boolean acceptSubscribe) {
