...
public class ConsumerNodeInfo {
     ...
     */
    public int getCurrentAllowedSize(
            final String storeKey,
            final FlowCtrlRuleHandler flowCtrlRuleHandler,
            final long currMaxDataOffset,
        ...
        if (lastDataRdOffset >= 0) {
            ...
            recalcMsgLimitValue(curDataDlt, currTime, maxMsgTransferSize, flowCtrlRuleHandler);
            if (isEscFlowCtrl
     ...
     * @param flowCtrlRuleHandler the flow-control rule handler
     */
    private void recalcMsgLimitValue(
            long curDataDlt,
            long currTime,
            int maxMsgTransferSize,
            final FlowCtrlRuleHandler flowCtrlRuleHandler) {
