...
/**
 * MsgStoreStatsHolder, The statistics set related to the message store, include
 * cache and file store statistics.
 *
 * Through this file storage statistics class, it mainly counts the number of
 * messages refreshed each time, the total data size, the total index size, the
 * total number of times the data file is full, the number of times the index
 * file is full, as well as the conditions that trigger the flush, the data
 * write information such as the number of refreshes that enter the timeout,
 * etc.
 *
...
public class MsgStoreStatsHolder {
     ...
     *
     * @param isDataSizeFull
     *          whether the cached data is full
     * @param isIndexSizeFull
     *          whether the cached index is full
     * @param isMsgCntFull
     *          whether the cached message count is full
     */
     ...
     * @param msgIndexSize
     *          the message index size written
     * @param msgDataSize
     *          the message data size written
     * @param flushedMsgCnt
     *          the flushed message count
     * @param flushedDataSize
     *          the flushed message size
     * @param isDataSegFlush
     *          whether the data segment flushed
     * @param isIndexSegFlush
     *          whether the index segment flushed
     * @param isDataSizeFull
     *          whether the cached data is full
     * @param isMsgCntFull
     *          whether the cached message count is full
     * @param isCacheTimeFull
     *          whether the cached time is full
     * @param isForceMetadata
     *          whether force push metadata
     * @param dltAppendTime
     ...
     *
     * @param strBuff
     *          the return information in json format
     */
    ...
    /**
     * Get current message store statistics information. Contains the data results
     * of the current statistics and the previous snapshot
     *
     * @param isSwitch
     *          whether to switch the writing statistics block
     * @param strBuff
     ...
     *
     * @param isWriting
     *          the metric block is writing
     * @param statsSet
     *          the metric block need to read
     * @param statsMap
     *          the read result
     */
