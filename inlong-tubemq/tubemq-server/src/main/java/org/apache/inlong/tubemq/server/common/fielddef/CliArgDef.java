...
public enum CliArgDef {
    ...
    HELP("h", "help", "Print usage information."), VERSION("v", "version", "Display TubeMQ version."),
    MASTERSERVER(null,
            "master-servers",
