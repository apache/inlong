...
public enum CliArgDef {
    ...
    PUSHCONSUME(null, "consume-push", "Push consumption action.(default: pull)"),
    FETCHTHREADS(
            null,
            "num-fetch-threads",
            "Integer: count, [1,100]",
    ...
    SYNCPRODUCE(null, "sync-produce", "Synchronous production. (default: false)"),
    WITHOUTDELAY(null, "without-delay", "Production without delay. (default: false)"),
    METHOD(null, "method", "String: http call method", "Http call method"),
    ADMINMETHOD(null, "show-methods", "Return http's methods."),
    FILEPATH("f", "file", "String: file path.", "File path."),
    METAFILEPATH(
            "path",
            "meta-file-path",
