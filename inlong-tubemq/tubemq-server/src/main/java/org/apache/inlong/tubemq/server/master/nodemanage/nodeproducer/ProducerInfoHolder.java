...
public class ProducerInfoHolder {
    ...
    public void setProducerInfo(
            String producerId, Set<String> topicSet, String host, boolean overTLS) {
        if (producerInfoMap.put(producerId, new ProducerInfo(producerId, topicSet, host, overTLS))
                == null) {
            MasterSrvStatsHolder.incProducerCnt();
        }
    }

    public void updateProducerInfo(
            String producerId, Set<String> topicSet, String host, boolean overTLS) {
