...
public enum WebFieldDef {
    ...
    FILTERCONDS(
            ...
            TBaseConstants.CFG_FLT_MAX_FILTER_ITEM_COUNT,
            RegexDef.TMP_FILTER),
    REQUIREREALOFFSET(
            8,
            "requireRealOffset",
            "dko",
            WebFieldType.BOOLEAN,
    ...
    COMPSTOPICNAME(
            ...
            RegexDef.TMP_STRING),
    COMPSPARTITIONID(
            12, "partitionId", "pid", WebFieldType.COMPINT, "Partition id", RegexDef.TMP_NUMBER),
    CALLERIP(
            13,
            "callerIp",
            "cip",
    ...
    COMPSBROKERID(
            15, "brokerId", "brokerId", WebFieldType.COMPINT, "Broker ID", RegexDef.TMP_NUMBER),
    WITHIP(
            16,
            "withIp",
            "ip",
    ...
    SRCGROUPNAME(
            ...
            "srcGroup",
            WebFieldType.STRING,
            "Offset clone source group name",
            TBaseConstants.META_MAX_GROUPNAME_LENGTH,
            RegexDef.TMP_GROUP),
    TGTCOMPSGROUPNAME(
            19,
            ...
            "tgtGroup",
            WebFieldType.COMPSTRING,
            "Offset clone target group name",
            TBaseConstants.META_MAX_GROUPNAME_LENGTH,
            RegexDef.TMP_GROUP),

    MANUALSET(
            20, "manualSet", "manSet", WebFieldType.BOOLEAN, "Whether manual offset setting mode"),
    OFFSETJSON(
            21,
            "offsetJsonInfo",
            "offsetInfo",
            WebFieldType.JSONDICT,
            "The offset info that needs to be added or modified"),
    ONLYMEM(
            22,
            "onlyMemory",
            "onlyMem",
    ...
    CLIENTID(
            ...
            WebFieldType.STRING,
            "Client ID",
            TBaseConstants.META_MAX_CLIENT_ID_LENGTH),
    @Deprecated
    CONSUMEGROUP(
            29,
            "consumeGroup",
    ...
    COMPREGIONID(
            32, "regionId", "regionId", WebFieldType.COMPINT, "Region id", RegexDef.TMP_NUMBER),
    DATAVERSIONID(
            33,
            "dataVersionId",
            "dataVerId",
            ...
            RegexDef.TMP_NUMBER),
    TOPICNAMEID(
            34, "topicNameId", "topicId", WebFieldType.LONG, "Topic name id", RegexDef.TMP_NUMBER),

    COMPTOPICNAMEID(
            35,
            "topicNameId",
            "topicId",
            WebFieldType.COMPLONG,
            "Topic name id",
            RegexDef.TMP_NUMBER),
    NUMTOPICSTORES(
            36,
    ...
    UNFLUSHTHRESHOLD(
            ...
            "unfDskMsgCnt",
            WebFieldType.INT,
            "Maximum allowed disk unflushing message count",
            RegexDef.TMP_NUMBER),
    UNFLUSHINTERVAL(
            39,
            "unflushInterval",
            "unfDskInt",
            WebFieldType.INT,
            "Maximum allowed disk unflushing interval",
            RegexDef.TMP_NUMBER),
    ...
    UNFLUSHDATAHOLD(
            ...
            "unfDskDataSize",
            WebFieldType.INT,
            "Maximum allowed disk unflushing data size",
            RegexDef.TMP_NUMBER),
    MCACHESIZEINMB(
            41,
            "memCacheMsgSizeInMB",
            "cacheSizeInMB",
            WebFieldType.INT,
            "Maximum allowed memory cache size in MB",
            RegexDef.TMP_NUMBER),
    UNFMCACHECNTINK(
            42,
            "memCacheMsgCntInK",
    ...
    MAXMSGSIZEINMB(
            ...
            "maxMsgSizeInMB",
            WebFieldType.INT,
            "Maximum allowed message length, unit MB",
            RegexDef.TMP_NUMBER),
    ...
    TOPICJSONSET(
            ...
            "The topic info set that needs to be added or modified"),
    BROKERIP(
            49,
            "brokerIp",
            "brokerIp",
    ...
    BROKERPORT(
            50, "brokerPort", "brokerPort", WebFieldType.INT, "Broker port", RegexDef.TMP_NUMBER),
    BROKERTLSPORT(
            51,
            "brokerTLSPort",
            "brokerTLSPort",
    ...
    BROKERJSONSET(
            ...
            "brokerSet",
            WebFieldType.JSONSET,
            "The broker info set that needs to be added or modified"),
    ...
    FILTERJSONSET(
            ...
            "filterJsonSet",
            WebFieldType.JSONSET,
            "The batch filter condition configure json array"),
    DATASTORETYPE(
            58,
            "dataStoreType",
            "dStType",
            ...
            "Data store type",
            RegexDef.TMP_NUMBER),
    DATAPATH(59, "dataPath", "dPath", WebFieldType.STRING, "Data path"),
    ...
    FLOWCTRLENABLE(
            62, "flowCtrlEnable", "fCtrlEn", WebFieldType.BOOLEAN, "Flow control enable status"),
    FLOWCTRLRULECOUNT(
            63,
            "flowCtrlRuleCount",
            "fCtrlCnt",
            WebFieldType.INT,
            "The count of flow control info set",
            RegexDef.TMP_NUMBER),
    RESCHECKENABLE(
            64, "resCheckEnable", "resChkEn", WebFieldType.BOOLEAN, "Resource check enable status"),

    ALWDBCRATE(
            65,
            "alwdBrokerClientRate",
            "abcr",
            WebFieldType.INT,
            "Allowed broker client rate",
            RegexDef.TMP_NUMBER),
    DSBCSMREASON(
            66,
            "disableCsmRsn",
    ...
    TOPICSTATUSID(
            70, "topicStatusId", "tStsId", WebFieldType.INT, "Status id", RegexDef.TMP_NUMBER),
    AUTHCTRLENABLE(
            71,
            "enableAuthControl",
            "acEn",
            WebFieldType.BOOLEAN,
            "Group authenticate control enable status"),
    ...
    GROUPCSMJSONSET(
            ...
            "csmJsonSet",
            WebFieldType.JSONSET,
            "The batch group consume configure json array"),
    ...
    ISINCLUDE(
            ...
            "isInclude",
            WebFieldType.BOOLEAN,
            "If include or un-include topic required"),
    COMPBROKERIP(
            76,
            "brokerIp",
            "bIp",
    ...
    ISRESERVEDDATA(
            ...
            "isRsvDt",
            WebFieldType.BOOLEAN,
            "Whether to keep topic data in the broker"),
    WITHGROUPAUTHINFO(
            78,
            "withGroupAuthInfo",
            "wGAI",
            WebFieldType.BOOLEAN,
            "With topic group authorize info."),
    ...
    OLDALWDBCRATE(
            ...
            "abcr",
            WebFieldType.INT,
            "Allowed broker client rate, same as alwdBrokerClientRate",
            RegexDef.TMP_NUMBER),
    @Deprecated
    GROUPJSONSET(
            83,
    ...
    REJOINWAIT(
            ...
            "rjWait",
            WebFieldType.INT,
            "The duration for consumer rejoin balance",
            RegexDef.TMP_NUMBER),
    ...
    COMPSCONSUMERID(
            ...
            WebFieldType.COMPSTRING,
            "consumer id",
            TServerConstants.CFG_CONSUMER_CLIENTID_MAX_LENGTH,
    ...
    RELREASON(
            ...
            TBaseConstants.META_MAX_OPREASON_LENGTH),
    WITHDETAIL(
            88, "withDetail", "wDtl", WebFieldType.BOOLEAN, "With broker configure detail info."),
    ONLYABNORMAL(
            89, "onlyAbnormal", "oAbn", WebFieldType.BOOLEAN, "only query abnormal broker info."),
    ...
    ONLYAUTOFBD(
            ...
            "oAfb",
            WebFieldType.BOOLEAN,
            "only auto forbidden abnormal broker info."),
    ONLYENABLETLS(
            91, "onlyEnableTLS", "oEtls", WebFieldType.BOOLEAN, "only enable tls broker info."),
    RECORDTIME(
            92,
            "recordTime",
            "rt",
    ...
    STATSTYPE(
            ...
            WebFieldType.STRING,
            "Statistics type",
            TServerConstants.META_MAX_STATSTYPE_LENGTH);
    ...
    WebFieldDef(
            int id, String name, String shortName, WebFieldType type, String desc, int valMaxLen) {
        this(
                id,
                name,
                shortName,
    ...
    WebFieldDef(
            ...
            String desc,
            RegexDef regexDef) {
        this(id, name, shortName, type, desc, TBaseConstants.META_VALUE_UNDEFINED, regexDef);
    }
    ...
    WebFieldDef(
            ...
            int itemMaxCnt,
            RegexDef regexDef) {
        this(id, name, shortName, type, desc, valMaxLen, itemMaxCnt, true, regexDef);
    }
    ...
    public static WebFieldDef valueOf(int fieldId) {
        ...
        throw new IllegalArgumentException(
                String.format(
                        "Unexpected WebFieldDef id `%s`, it should be between `%s` "
                                + "and `%s` (inclusive)",
                        fieldId, MIN_FIELD_ID, MAX_FIELD_ID));
    }
}
