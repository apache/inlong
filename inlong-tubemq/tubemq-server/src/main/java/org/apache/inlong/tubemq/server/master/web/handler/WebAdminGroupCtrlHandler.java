...
public class WebAdminGroupCtrlHandler extends AbstractWebHandler {
    ...
    public void registerWebApiMethod() {
        ...
        registerQueryWebMethod(
                "admin_query_allowed_consumer_group_info", "adminQueryConsumerGroupInfo");
        registerQueryWebMethod(
                "admin_query_group_filtercond_info", "adminQueryGroupFilterCondInfo");
        registerQueryWebMethod(
                "admin_query_consume_group_setting", "adminQueryConsumeGroupSetting");
        // register modify method
        registerModifyWebMethod("admin_add_black_consumergroup_info", "adminAddBlackGroupInfo");
        registerModifyWebMethod(
                "admin_bath_add_black_consumergroup_info", "adminBatchAddBlackGroupInfo");
        registerModifyWebMethod(
                "admin_delete_black_consumergroup_info", "adminDeleteBlackGroupInfo");
        registerModifyWebMethod(
                "admin_batch_delete_black_consumergroup_info", "adminBatchDeleteBlackGroupInfo");
        registerModifyWebMethod(
                "admin_add_authorized_consumergroup_info", "adminAddConsumerGroupInfo");
        registerModifyWebMethod(
                "admin_delete_allowed_consumer_group_info", "adminDeleteConsumerGroupInfo");
        registerModifyWebMethod(
                "admin_batch_del_authorized_consumergroup_info", "adminBatchDelConsumerGroupInfo");
        registerModifyWebMethod(
                "admin_bath_add_authorized_consumergroup_info", "adminBatchAddConsumerGroupInfo");
        registerModifyWebMethod("admin_add_group_filtercond_info", "adminAddGroupFilterCondInfo");
        registerModifyWebMethod(
                "admin_bath_add_group_filtercond_info", "adminBatchAddGroupFilterCondInfo");
        registerModifyWebMethod("admin_mod_group_filtercond_info", "adminModGroupFilterCondInfo");
        registerModifyWebMethod(
                "admin_bath_mod_group_filtercond_info", "adminBatchModGroupFilterCondInfo");
        registerModifyWebMethod(
                "admin_del_group_filtercond_info", "adminDeleteGroupFilterCondInfo");
        registerModifyWebMethod(
                "admin_add_consume_group_setting", "adminAddConsumeGroupSettingInfo");
        registerModifyWebMethod(
                "admin_bath_add_consume_group_setting", "adminBatchAddConsumeGroupSetting");
        registerModifyWebMethod("admin_upd_consume_group_setting", "adminUpdConsumeGroupSetting");
        registerModifyWebMethod(
                "admin_del_consume_group_setting", "adminDeleteConsumeGroupSetting");
        registerModifyWebMethod(
     ...
     */
    public StringBuilder adminQueryBlackGroupInfo(
        ...
        for (List<GroupConsumeCtrlEntity> entryList : qryResult.values()) {
            for (GroupConsumeCtrlEntity entry : entryList) {
                ...
                sBuffer.append("{\"groupName\":\"")
                        .append(entry.getGroupName())
                        .append("\",\"topicName\":\"")
                        .append(entry.getTopicName())
                        .append("\",\"reason\":\"")
                        .append(entry.getDisableReason())
                        .append("\",\"dataVersionId\":")
                        .append(entry.getDataVerId())
                        .append(",\"createUser\":\"")
                        .append(entry.getCreateUser())
                        .append("\",\"createDate\":\"")
                        .append(entry.getCreateDateStr())
                        .append("\",\"modifyUser\":\"")
                        .append(entry.getModifyUser())
                        .append("\",\"modifyDate\":\"")
                        .append(entry.getModifyDateStr())
                        .append("\"}");
            }
        }
     ...
     * @return process result
     */
    public StringBuilder adminQueryConsumerGroupInfo(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result) {
        // build query entity
     ...
     * @return process result
     */
    public StringBuilder adminQueryGroupFilterCondInfo(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result) {
        // build query entity
        GroupConsumeCtrlEntity qryEntity = new GroupConsumeCtrlEntity();
        // get queried operation info, for createUser, modifyUser, dataVersionId
        ...
        for (List<GroupConsumeCtrlEntity> consumeCtrlEntityList : qryResultMap.values()) {
            ...
            for (GroupConsumeCtrlEntity entry : consumeCtrlEntityList) {
                ...
                itemFilterStr =
                        (entry.getFilterCondStr().length() <= 2) ? "" : entry.getFilterCondStr();
                sBuffer.append("{\"topicName\":\"")
                        .append(entry.getTopicName())
                        .append("\",\"groupName\":\"")
                        .append(entry.getGroupName())
     ...
     * @return process result
     */
    public StringBuilder adminQueryConsumeGroupSetting(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result) {
        // build query entity
     ...
     * @return process result
     */
    public StringBuilder adminAddBlackGroupInfo(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result) {
        ...
        Set<String> groupNameSet = (Set<String>) result.getRetData();
        // check and get topicName field
        if (!WebParameterUtils.getAndValidTopicNameInfo(
                req, defMetaDataService, true, null, sBuffer, result)) {
            WebParameterUtils.buildFailResult(sBuffer, result.getErrMsg());
            return sBuffer;
        }
        Set<String> topicNameSet = (Set<String>) result.getRetData();
        ...
        for (String groupName : groupNameSet) {
            for (String topicName : topicNameSet) {
                ...
                retInfoList.add(
                        defMetaDataService.insertConsumeCtrlInfo(
                                opEntity,
                                groupName,
                                topicName,
                                Boolean.FALSE,
                                "Old API add blacklist, disable consume",
                                null,
                                null,
                                sBuffer,
                                result));
     ...
     * @return process result
     */
    public StringBuilder adminBatchAddBlackGroupInfo(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result) {
        // check and get operation info
        if (!WebParameterUtils.getAUDBaseInfo(req, true, null, sBuffer, result)) {
            WebParameterUtils.buildFailResult(sBuffer, result.getErrMsg());
        ...
        if (!getGroupCsmJsonSetInfo(
                req, opEntity, Boolean.FALSE, "Old API batch set BlackList", sBuffer, result)) {
            WebParameterUtils.buildFailResult(sBuffer, result.getErrMsg());
            return sBuffer;
        }
        ...
        for (GroupConsumeCtrlEntity entry : addRecordMap.values()) {
            ctrlEntity =
                    defMetaDataService.getConsumeCtrlByGroupAndTopic(
                            entry.getGroupName(), entry.getTopicName());
            if (ctrlEntity != null
                    && ctrlEntity.getConsumeEnable() == EnableStatus.STATUS_DISABLE) {
                result.setFailResult(DataOpErrCode.DERR_SUCCESS.getCode(), "Ok!");
                retInfoList.add(
                        new GroupProcessResult(entry.getGroupName(), entry.getTopicName(), result));
                continue;
            }
     ...
     * @return process result
     */
    public StringBuilder adminDeleteBlackGroupInfo(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result) {
        // check and get operation info
                ...
                if (!entry.getValue().isEmpty()) {
                    for (GroupConsumeCtrlEntity ctrlEntity : entry.getValue()) {
                        if (ctrlEntity != null
                            ...
                            defMetaDataService.insertConsumeCtrlInfo(
                                    opEntity,
                                    ctrlEntity.getGroupName(),
                                    ctrlEntity.getTopicName(),
                                    Boolean.TRUE,
     ...
     * @return process result
     */
    public StringBuilder adminBatchDeleteBlackGroupInfo(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result) {
        // check and get operation info
        if (!WebParameterUtils.getAUDBaseInfo(req, false, null, sBuffer, result)) {
            WebParameterUtils.buildFailResult(sBuffer, result.getErrMsg());
        ...
        // check and get groupNameJsonSet info
        if (!getGroupCsmJsonSetInfo(
                req, opEntity, null, "Old API batch Disable consume", sBuffer, result)) {
            WebParameterUtils.buildFailResult(sBuffer, result.getErrMsg());
            return sBuffer;
        }
        Map<String, GroupConsumeCtrlEntity> addRecordMap =
     ...
     * @return process result
     */
    public StringBuilder adminAddConsumerGroupInfo(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result) {
        // check and get operation info
        if (!WebParameterUtils.getAUDBaseInfo(req, true, null, sBuffer, result)) {
            WebParameterUtils.buildFailResult(sBuffer, result.getErrMsg());
     ...
     * @return process result
     */
    public StringBuilder adminBatchAddConsumerGroupInfo(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result) {
        // check and get operation info
        if (!WebParameterUtils.getAUDBaseInfo(req, true, null, sBuffer, result)) {
            WebParameterUtils.buildFailResult(sBuffer, result.getErrMsg());
        ...
        // check and get groupNameJsonSet info
        if (!getGroupCsmJsonSetInfo(
                req, opEntity, Boolean.TRUE, "Old API batch set Enable Consume", sBuffer, result)) {
            WebParameterUtils.buildFailResult(sBuffer, result.getErrMsg());
            return sBuffer;
        }
        Map<String, GroupConsumeCtrlEntity> addRecordMap =
     ...
     * @return process result
     */
    public StringBuilder adminDeleteConsumerGroupInfo(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result) {
        // check and get operation info
        if (!WebParameterUtils.getAUDBaseInfo(req, false, null, sBuffer, result)) {
            WebParameterUtils.buildFailResult(sBuffer, result.getErrMsg());
     ...
     * @return process result
     */
    public StringBuilder adminBatchDelConsumerGroupInfo(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result) {
        // check and get operation info
        if (!WebParameterUtils.getAUDBaseInfo(req, false, null, sBuffer, result)) {
            WebParameterUtils.buildFailResult(sBuffer, result.getErrMsg());
        ...
        if (!getGroupCsmJsonSetInfo(
                ...
                opEntity,
                Boolean.FALSE,
                "Old API batch delete Authorized Consume",
                sBuffer,
                result)) {
            WebParameterUtils.buildFailResult(sBuffer, result.getErrMsg());
            return sBuffer;
     ...
     * @return process result
     */
    public StringBuilder adminAddGroupFilterCondInfo(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result) {
     ...
     * @return process result
     */
    public StringBuilder adminModGroupFilterCondInfo(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result) {
     ...
     * @return process result
     */
    public StringBuilder adminBatchAddGroupFilterCondInfo(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result) {
     ...
     * @return process result
     */
    public StringBuilder adminBatchModGroupFilterCondInfo(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result) {
     ...
     * @return process result
     */
    public StringBuilder adminDeleteGroupFilterCondInfo(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result) {
        // check and get operation info
        if (!WebParameterUtils.getAUDBaseInfo(req, false, null, sBuffer, result)) {
            WebParameterUtils.buildFailResult(sBuffer, result.getErrMsg());
                ...
                for (GroupConsumeCtrlEntity ctrlEntity : entry.getValue()) {
                    if (ctrlEntity != null
                        ...
                        defMetaDataService.insertConsumeCtrlInfo(
                                ...
                                ctrlEntity.getTopicName(),
                                null,
                                "Old API delete, disable filter",
                                false,
                                TServerConstants.BLANK_FILTER_ITEM_STR,
                                sBuffer,
                                result);
                    }
                }
     ...
     * @return process result
     */
    public StringBuilder adminRebalanceGroupAllocateInfo(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result) {
        // check and get operation info
        if (!WebParameterUtils.getAUDBaseInfo(req, false, null, sBuffer, result)) {
            WebParameterUtils.buildFailResult(sBuffer, result.getErrMsg());
        ...
        if (!WebParameterUtils.getStringParamValue(
                req, WebFieldDef.GROUPNAME, true, "", sBuffer, result)) {
            WebParameterUtils.buildFailResult(sBuffer, result.getErrMsg());
            return sBuffer;
        }
        ...
        // get reJoinWait info
        if (!WebParameterUtils.getIntParamValue(
                req, WebFieldDef.REJOINWAIT, false, 0, 0, sBuffer, result)) {
            WebParameterUtils.buildFailResult(sBuffer, result.getErrMsg());
            return sBuffer;
        }
        ...
        // get consumerId list
        if (!WebParameterUtils.getStringParamValue(
                req, WebFieldDef.COMPSCONSUMERID, true, null, sBuffer, result)) {
            WebParameterUtils.buildFailResult(sBuffer, result.getErrMsg());
            return sBuffer;
        }
        ...
        for (String consumerId : consumerIdSet) {
            if (nodeRebInfoMap.containsKey(consumerId)) {
                String errInfo =
                        sBuffer.append("Duplicated set for consumerId(")
                                .append(consumerId)
                                .append(") in group(")
                                .append(groupName)
                                .append(")! \"}")
        ...
        logger.info(
                sBuffer.append("[Re-balance] Add rebalance consumer: group=")
                        .append(groupName)
                        .append(", consumerIds=")
     ...
     * @return process result
     */
    public StringBuilder adminAddConsumeGroupSettingInfo(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result) {
     ...
     * @return process result
     */
    public StringBuilder adminUpdConsumeGroupSetting(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result) {
     ...
     * @return process result
     */
    public StringBuilder adminBatchAddConsumeGroupSetting(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result) {
        // check and get operation info
        if (!WebParameterUtils.getAUDBaseInfo(req, true, null, sBuffer, result)) {
            WebParameterUtils.buildFailResult(sBuffer, result.getErrMsg());
        ...
        for (GroupResCtrlEntity resCtrlEntity : addRecordMap.values()) {
            retInfoList.add(defMetaDataService.insertGroupCtrlConf(resCtrlEntity, sBuffer, result));
        }
        return buildRetInfo(retInfoList, sBuffer);
    }
     ...
     * @return process result
     */
    public StringBuilder adminDeleteConsumeGroupSetting(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result) {
        // check and get operation info
        if (!WebParameterUtils.getAUDBaseInfo(req, false, null, sBuffer, result)) {
            WebParameterUtils.buildFailResult(sBuffer, result.getErrMsg());
        ...
        for (String groupName : groupNameSet) {
            retInfoList.add(
                    defMetaDataService.addOrUpdGroupCtrlConf(
                            false,
                            opEntity,
                            groupName,
                            Boolean.FALSE,
     ...
     * @return process result
     */
    private StringBuilder innAddOrUpdConsumeGroupSettingInfo(
        ...
        if (!WebParameterUtils.getIntParamValue(
                ...
                false,
                (isAddOp
                        ? TServerConstants.GROUP_BROKER_CLIENT_RATE_MIN
                        : TBaseConstants.META_VALUE_UNDEFINED),
                TServerConstants.GROUP_BROKER_CLIENT_RATE_MIN,
                sBuffer,
                result)) {
        ...
        for (String groupName : groupNameSet) {
            retInfoList.add(
                    defMetaDataService.insertGroupCtrlConf(
                            opEntity,
                            groupName,
                            resChkEnable,
                            allowedBClientRate,
     ...
     * @return process result
     */
    private StringBuilder innAddOrModGroupFilterCondInfo(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result, boolean isAddOp) {
        // check and get operation info
        if (!WebParameterUtils.getAUDBaseInfo(req, isAddOp, null, sBuffer, result)) {
            WebParameterUtils.buildFailResult(sBuffer, result.getErrMsg());
     ...
     * @return process result
     */
    private StringBuilder innBatchAddOrUpdGroupFilterCondInfo(
            HttpServletRequest req, StringBuilder sBuffer, ProcessResult result, boolean isAddOp) {
        // check and get operation info
        if (!WebParameterUtils.getAUDBaseInfo(req, isAddOp, null, sBuffer, result)) {
            WebParameterUtils.buildFailResult(sBuffer, result.getErrMsg());
    ...
    private boolean getFilterJsonSetInfo(
        ...
        if (!WebParameterUtils.getJsonArrayParamValue(
                req, WebFieldDef.FILTERJSONSET, true, null, result)) {
        ...
        for (Map<String, String> itemValueMap : groupJsonArray) {
            ...
            String filterCondStr = (String) result.getRetData();
            itemEntity = new GroupConsumeCtrlEntity(itemOpEntity, groupName, topicName);
            itemEntity.updModifyInfo(
                    itemOpEntity.getDataVerId(), null, null, filterEnable, filterCondStr);
            addRecordMap.put(itemEntity.getRecordKey(), itemEntity);
        }
        // check result
        if (addRecordMap.isEmpty()) {
            result.setFailResult(
                    sBuffer.append("Not found record info in ")
    ...
    private boolean getGroupCtrlJsonSetInfo(
            HttpServletRequest req,
            BaseEntity defOpEntity,
            StringBuilder sBuffer,
            ProcessResult result) {
        if (!WebParameterUtils.getJsonArrayParamValue(
                req, WebFieldDef.GROUPJSONSET, true, null, result)) {
            return result.isSuccess();
        }
        List<Map<String, String>> groupJsonArray = (List<Map<String, String>>) result.getRetData();
        ...
        for (int j = 0; j < groupJsonArray.size(); j++) {
            ...
            // check and get operation info
            if (!WebParameterUtils.getAUDBaseInfo(
                    itemValueMap, true, defOpEntity, sBuffer, result)) {
                return result.isSuccess();
            }
            final BaseEntity itemOpEntity = (BaseEntity) result.getRetData();
            // get group configure info
            ...
            // get resCheckStatus info
            if (!WebParameterUtils.getBooleanParamValue(
                    itemValueMap, WebFieldDef.RESCHECKENABLE, false, false, sBuffer, result)) {
                return result.isSuccess();
            }
            Boolean resChkEnable = (Boolean) result.getRetData();
            // get and valid allowedBClientRate info
    ...
    private boolean getGroupCsmJsonSetInfo(
            HttpServletRequest req,
            BaseEntity defOpEntity,
            Boolean enableCsm,
            String opReason,
    ...
    private <T> boolean getCondStatusParamValue(
            T paramCntr,
            boolean required,
            Boolean defValue,
            StringBuilder sBuffer,
