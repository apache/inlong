...
public class NodeRebInfo {
    ...
    public NodeRebInfo(
            String clientId, int status, long createTime, int reqType, int waitDuration) {
        this.clientId = clientId;
        this.status = status;
    ...
    public NodeRebInfo clone() {
        return new NodeRebInfo(
                this.clientId, this.status, this.createTime, this.reqType, this.waitDuration.get());
    }

    public StringBuilder toJsonString(final StringBuilder sBuilder) {
        return sBuilder.append("{\"clientId\":\"")
                .append(clientId)
                .append("\",\"status\":")
                .append(status)
                .append(",\"createTime\":")
