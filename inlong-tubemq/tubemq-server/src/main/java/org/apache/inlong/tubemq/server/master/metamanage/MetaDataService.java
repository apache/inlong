...
public interface MetaDataService extends Server {
     ...
     */
    boolean isConsumeTargetAuthorized(
            String consumerId,
            String groupName,
     ...
     */
    boolean addOrUpdClusterDefSetting(
            BaseEntity opEntity,
            int brokerPort,
            int brokerTlsPort,
            int brokerWebPort,
     ...
     */
    BrokerProcessResult addOrUpdBrokerConfig(
            boolean isAddOp,
            BaseEntity opEntity,
            int brokerId,
            String brokerIp,
     ...
     * @return true if success otherwise false
     */
    BrokerProcessResult changeBrokerConfStatus(
            BaseEntity opEntity,
            int brokerId,
     ...
     * @return true if success otherwise false
     */
    BrokerProcessResult reloadBrokerConfInfo(
     ...
     * @return true if success otherwise false
     */
    BrokerProcessResult delBrokerConfInfo(
            String operator,
            boolean rsvData,
            int brokerId,
            StringBuilder strBuff,
     ...
     */
    Map<Integer, BrokerConfEntity> getBrokerConfInfo(
     ...
     * @return true if success otherwise false
     */
    boolean delCleanedTopicDeployInfo(
            int brokerId, List<String> removedTopics, StringBuilder strBuff, ProcessResult result);

    /**
     * Get broker's topicName set, if brokerIds is empty, then return all broker's topicNames
     *
     * @param brokerIdSet the broker id set need to query
     ...
     * @return true if success otherwise false
     */
    TopicProcessResult addOrUpdTopicDeployInfo(
            boolean isAddOp,
            BaseEntity opEntity,
            int brokerId,
            String topicName,
     ...
     * @return true if success otherwise false
     */
    TopicProcessResult updTopicDeployStatusInfo(
            BaseEntity opEntity,
            int brokerId,
            String topicName,
     ...
     */
    Map<String, List<TopicDeployEntity>> getTopicDeployInfoMap(
     ...
     * @return topic deploy information map
     */
    Map<Integer, List<TopicDeployEntity>> getTopicDeployInfoMap(
     ...
     * @return topic deploy information map
     */
    Map<String, List<TopicDeployEntity>> getTopicConfMapByTopicAndBrokerIds(
            Set<String> topicNameSet, Set<Integer> brokerIdSet);
     ...
     */
    Map<String, String> getBrokerTopicStrConfigInfo(
     ...
     * @return true if success otherwise false
     */
    TopicProcessResult addOrUpdTopicCtrlConf(
            boolean isAddOp,
            BaseEntity opEntity,
            String topicName,
            int topicNameId,
     ...
     * @return true if success otherwise false
     */
    TopicProcessResult insertTopicCtrlConf(
            BaseEntity opEntity,
            String topicName,
            Boolean enableTopicAuth,
            StringBuilder strBuff,
     ...
     */
    Map<String, TopicCtrlEntity> getTopicCtrlConf(
     ...
     * @return true if success otherwise false
     */
    GroupProcessResult addOrUpdGroupCtrlConf(
            boolean isAddOp,
            BaseEntity opEntity,
            String groupName,
     ...
     * @return true if success otherwise false
     */
    GroupProcessResult insertGroupCtrlConf(
            BaseEntity opEntity,
            String groupName,
            int qryPriorityId,
            Boolean flowCtrlEnable,
     ...
     * @return true if success otherwise false
     */
    GroupProcessResult delGroupResCtrlConf(
     ...
     * @return query result
     */
    Map<String, GroupResCtrlEntity> getGroupCtrlConf(
     ...
     * @return true if success otherwise false
     */
    GroupProcessResult addOrUpdConsumeCtrlInfo(
            boolean isAddOp,
            BaseEntity opEntity,
            String groupName,
            String topicName,
     ...
     */
    GroupProcessResult insertConsumeCtrlInfo(
            BaseEntity opEntity,
            String groupName,
            String topicName,
            Boolean enableCsm,
