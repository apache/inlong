...
public interface MetaDataService extends Server {
     ...
     *          checked group name
     * @param reqTopicSet
     *          consumer request topic set
     * @param reqTopicCondMap
     *          consumer request filter items
     * @param strBuff
     *          the print information string buffer
     * @param result
     *          the process result return
     ...
     *          broker web port
     * @param maxMsgSizeMB
     *          max cluster message size in MB
     * @param qryPriorityId
     *          the default query priority id
     * @param flowCtrlEnable
     *          enable or disable flow control function
     * @param flowRuleCnt
     *          the default flow rule count
     * @param flowCtrlInfo
     *          the default flow control information
     * @param topicProps
     *          default topic property information
     * @param strBuff
     *          the print information string buffer
     * @param result
     *          the process result return
     ...
     *
     * @param isMustConf
     *          whether must be configured data.
     ...
     *          whether add operation
     * @param entity
     *          need add or update configure information
     * @param strBuff
     *          the print information string buffer
     * @param result
     *          the process result return
     ...
     *          operator
     * @param rsvData
     *          if reserve topic's data info
     * @param brokerId
     *          need deleted broker id set
     * @param strBuff
     *          the print information string buffer
     * @param result
     *          the process result return
     ...
     *
     * @param qryEntity
     *          the query condition, must not null
     ...
     *
     * @param brokerIdSet
     *          the broker id set need to query
     * @param brokerIpSet
     *          the broker ip set need to query
     * @param qryEntity
     *          the query condition
    ...
    /**
     * Get broker's topicName set, if brokerIds is empty, then return all broker's
     * topicNames
     *
     * @param brokerIdSet
     *          the broker id set need to query
     ...
     *
     * @param topicNameSet
     *          the topic name set need to query
     ...
     *
     * @param topicNameSet
     *          query by topicNameSet
     * @param brokerIdSet
     *          query by brokerIdSet
     * @param qryEntity
     *          query conditions
    ...
    /**
     * Get topic deploy information, if the result matched is null, then return
     * empty
     *
     * @param topicNameSet
     *          query by topicNameSet
     ...
     *
     * @param brokerConfEntity
     *          broker configure entity
     * @param strBuff
     *          the string buffer
     ...
     *          whether enable topic authentication
     * @param maxMsgSizeInMB
     *          the max message size in MB
     * @param strBuff
     *          the print info string buffer
     * @param result
     *          the process result return
     ...
     *          whether add operation
     * @param entityMap
     *          the topic control entity map which will be add
     * @param strBuff
     *          the print info string buffer
     * @param result
     *          the process result return
     ...
     * @param groupName
     *          the group name
     * @param resCheckEnable
     *          whether check resource rate
     * @param allowedBClientRate
     *          the allowed broker-client rate
     * @param qryPriorityId
     *          the query priority id
     * @param flowCtrlEnable
     *          enable or disable flow control
     * @param flowRuleCnt
     *          the flow control rule count
     * @param flowCtrlInfo
     ...
     *
     * @param entity
     *          the group control info entity will be add
     * @param strBuff
     *          the print info string buffer
     * @param result
     *          the process result return
     ...
     *
     * @param opEntity
     *          the group resource control info entity will be add
     * @param groupName
     *          operate target
     * @param resChkEnable
     ...
     *          whether add operation
     * @param entity
     *          need add or update group configure info
     * @param strBuff
     *          the print info string buffer
     * @param result
     *          the process result return
     ...
     *
     * @param opEntity
     *          add or update base information, include creator, create time, etc.
     * @param groupName
     *          add or update groupName information
     * @param topicName
     *          add or update topicName information
     * @param enableCsm
     *          add or update consume enable status information
     * @param disReason
     *          add or update disable consume reason
     * @param enableFlt
     *          add or update filter enable status information
     * @param fltCondStr
     *          add or update filter configure information
     * @param strBuff
     *          the print info string buffer
     * @param result
     *          the process result return
     ...
     *
     * @param entity
     *          add or update group consume control info
     * @param strBuff
     *          the print info string buffer
     * @param result
     *          the process result return
