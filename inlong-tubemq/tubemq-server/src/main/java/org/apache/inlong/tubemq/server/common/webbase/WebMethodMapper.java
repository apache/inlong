...
public class WebMethodMapper {
    ...
    public static void registerWebMethod(
        ...
        logger.error(
                new StringBuilder(512)
                        ...
                        .append(clsMethodName)
                        .append(" in WebHandler class ")
                        .append(webHandler.getClass().getName())
                        .toString());
    }
    ...
    public static int getRegisteredWebMethod(StringBuilder sBuffer) {
        ...
        for (Map.Entry<String, WebMethodMapper.WebApiRegInfo> entry : WEB_METHOD_MAP.entrySet()) {
            ...
            sBuffer.append("{\"method\":\"")
                    .append(entry.getKey())
                    .append("\",\"needAuth\":")
                    .append(entry.getValue().needAuthToken)
                    .append("}");
        }
        return totalCnt;
    }
    ...
    public static class WebApiRegInfo {
        ...
        public WebApiRegInfo(
                Method method, Object webHandler, boolean onlyMasterOp, boolean needAuthToken) {
            this.method = method;
