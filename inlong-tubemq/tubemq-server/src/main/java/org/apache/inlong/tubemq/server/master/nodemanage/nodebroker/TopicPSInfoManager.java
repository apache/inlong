...
public class TopicPSInfoManager {
     ...
     *          the group name
     * @param topicSet
     *          the topic set which the group subscribed
     */
     ...
     *
     * @param group
     *          the group name which needs removed topic
     * @param topicSet
     *          the topic set which the group name subscribed
     */
     ...
     *
     * @param producerId
     *          need removed producer id
     * @param topicList
     *          need removed topic set
     */
    ...
    /**
     * Get the set of online groups subscribed to the specified topic. If the
     * specified query consumer group is empty, then the full amount of online
     * consumer groups will be taken; if the specified subscription topic is empty,
     * then all online consumer groups will be taken.
     *
     * @param qryGroupSet
     * @param subTopicSet
