...
public class VelocityTemplateEngine implements TemplateEngine {
    ...
    public void init() throws Exception {
        if (TStringUtils.isEmpty(config.getVelocityConfigFilePath())) {
            ...
            engine.setProperty(
                    VelocityEngine.INPUT_ENCODING, TBaseConstants.META_DEFAULT_CHARSET_NAME);
            engine.init();
        } else {
    ...
    @Override
    public void renderTemplate(String templateName, RequestContext context, Writer writer)
            throws Exception {
