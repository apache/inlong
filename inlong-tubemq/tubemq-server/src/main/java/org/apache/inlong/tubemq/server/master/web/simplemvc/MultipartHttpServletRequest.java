...
public class MultipartHttpServletRequest extends HttpServletRequestWrapper {
    ...
    public MultipartHttpServletRequest(HttpServletRequest request) {
        ...
        // If the data size is trivial like tens of bytes, there's simply no need to do
        // this.
    }

    /**
     * It's not the recommended way to handle "multipart/form-data", as form-data
     * can carry non-char data like bytes array. Provided currently there's ONLY
     * string used in WebAPI, so for CONVENIENT, this function translate all
     * form-data to traditional "parameters" (like how it does in
     * "x-www-form-urlencoded") for reusing current dispatcher-execute framework. If
     * one day there's need to received serialized POJO or some kinds of binary
     * stream, please compose a full powered function to replace this one, as this
