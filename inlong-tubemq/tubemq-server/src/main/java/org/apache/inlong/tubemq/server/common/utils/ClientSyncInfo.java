...
public class ClientSyncInfo {
     ...
     */
    public void updSubRepInfo(
            BrokerRunManager brokerRunManager, ClientMaster.ClientSubRepInfo clientSubRepInfo) {
            ...
            if (this.repPartInfo) {
                for (String info : clientSubRepInfo.getPartSubInfoList()) {
                    ...
                    for (String partStr : strPartInfoSet) {
                        ...
                        subPartSet.add(
                                new Partition(
                                        brokerInfo, strInfo[0], Integer.parseInt(strPartInfo[1])));
                    }
                }
            }
            this.updated = true;
