...
public class TopicDeployEntity extends BaseEntity implements Cloneable {
    ...
    public TopicDeployEntity(
            BaseEntity opInfoEntity, int brokerId, String topicName, TopicPropGroup topicProps) {
        super(opInfoEntity);
        this.brokerId = brokerId;
        this.topicName = topicName;
        this.recordKey = KeyBuilderUtils.buildTopicConfRecKey(brokerId, topicName);
    ...
    private void setTopicDeployInfo(
            int brokerId, String brokerIp, int brokerPort, String topicName) {
        this.brokerId = brokerId;
    ...
    /**
     * Check whether the specified query item value matches Allowed query items: brokerId, topicId,
    ...
    public StringBuilder toWebJsonStr(
        ...
        if (isLongName) {
            sBuilder.append("{\"topicName\":\"")
                    ...
                    .append(",\"brokerPort\":")
                    .append(brokerPort)
                    .append(",\"topicStatusId\":")
                    .append(deployStatus.getCode());
        } else {
