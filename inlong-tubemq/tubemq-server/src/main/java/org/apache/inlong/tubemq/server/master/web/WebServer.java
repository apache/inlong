...
public class WebServer implements Server {
    ...
    public void start() throws Exception {
        ...
        servletContext.addFilter(
                new FilterHolder(new MasterStatusCheckFilter(master)),
                "/*",
                EnumSet.of(REQUEST, ASYNC));
        servletContext.addFilter(
                new FilterHolder(new UserAuthFilter()), "/*", EnumSet.of(REQUEST, ASYNC));
        servletContext.addFilter(
                new FilterHolder(new WebFilter()), "/*", EnumSet.of(REQUEST, ASYNC));
