...
public abstract class AbstractWebHandler {
    ...
    protected void registerQueryWebMethod(String webMethodName, String clsMethodName) {
        innRegisterWebMethod(webMethodName, clsMethodName, false, false);
    }

    protected void registerModifyWebMethod(String webMethodName, String clsMethodName) {
    ...
    private void innRegisterWebMethod(
            String webMethodName,
            String clsMethodName,
            boolean onlyMasterOp,
            boolean needAuthToken) {
        registerWebMethod(webMethodName, clsMethodName, onlyMasterOp, needAuthToken, this);
    }
}
