...
public interface MetaConfigMapper extends KeepAliveService {
     ...
     * @return true if success otherwise false
     */
    boolean changeBrokerConfStatus(
            BaseEntity opEntity,
            int brokerId,
     ...
     */
    void addSystemTopicDeploy(int brokerId, int brokerPort, String brokerIp, StringBuilder strBuff);
     ...
     * @return true if success otherwise false
     */
    boolean addOrUpdTopicDeployInfo(
            boolean isAddOp,
     ...
     * @return true if success otherwise false
     */
    boolean updTopicDeployStatusInfo(
            BaseEntity opEntity,
            int brokerId,
            String topicName,
     ...
     * @return true if success otherwise false
     */
    boolean addOrUpdGroupResCtrlConf(
            boolean isAddOp,
     ...
     * @return true if success otherwise false
     */
    boolean addOrUpdConsumeCtrlInfo(
            boolean isAddOp,
