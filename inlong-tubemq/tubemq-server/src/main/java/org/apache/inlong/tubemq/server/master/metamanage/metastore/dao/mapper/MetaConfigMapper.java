...
public interface MetaConfigMapper extends KeepAliveService {
     ...
     *          whether add operation
     * @param entity
     *          the topic control info entity will be added
     * @param strBuff
