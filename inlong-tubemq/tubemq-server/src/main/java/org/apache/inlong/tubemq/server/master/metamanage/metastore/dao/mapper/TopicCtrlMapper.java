...
public interface TopicCtrlMapper extends AbstractMapper {
     ...
     */
    boolean addTopicCtrlConf(TopicCtrlEntity entity, StringBuilder strBuff, ProcessResult result);
     ...
     * @return the process result
     */
    boolean updTopicCtrlConf(TopicCtrlEntity entity, StringBuilder strBuff, ProcessResult result);
