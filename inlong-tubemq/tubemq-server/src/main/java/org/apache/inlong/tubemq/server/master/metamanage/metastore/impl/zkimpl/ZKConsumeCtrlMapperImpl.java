...
public class ZKConsumeCtrlMapperImpl extends AbsConsumeCtrlMapperImpl {
    ...
    public ZKConsumeCtrlMapperImpl(
        ...
        this.csmCtrlRootDir =
                strBuff.append(metaNodePrefix)
                        ...
                        .append(TZKNodeKeys.ZK_LEAF_CONSUME_CTRL_CONFIG)
                        .toString();
    ...
    public void loadConfig(StringBuilder strBuff) throws LoadMetaException {
        ...
        for (String itemKey : childNodes) {
            ...
            try {
                ...
                logger.error(
                        "KeeperException during load consume control configure from ZooKeeper", e);
        ...
        logger.info(
                strBuff.append("[ZK Impl] loaded ")
                        .append(totalCnt)
                        .append(" consume control configure successfully...")
                        .toString());
        strBuff.delete(0, strBuff.length());
    }
