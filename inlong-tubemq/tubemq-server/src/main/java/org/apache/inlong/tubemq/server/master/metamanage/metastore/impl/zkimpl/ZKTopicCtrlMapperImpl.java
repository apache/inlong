    ...
    public void loadConfig(StringBuilder strBuff) throws LoadMetaException {
            ...
            try {
                recordStr =
                        ZKUtil.readDataMaybeNull(
                                zkWatcher,
                                strBuff.append(topicCtrlRootDir)
                                        .append(TokenConstants.SLASH)
                                        .append(itemKey)
                                        .toString());
                strBuff.delete(0, strBuff.length());
                ...
                logger.error(
                        "KeeperException during load topic control configure from ZooKeeper", e);
        ...
        logger.info(
                strBuff.append("[ZK Impl] loaded ")
                        .append(totalCnt)
                        .append(" topic control configure successfully...")
                        .toString());
        strBuff.delete(0, strBuff.length());
    }
