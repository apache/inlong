    ...
    public void loadConfig(StringBuilder strBuff) throws LoadMetaException {
            ...
            try {
                recordStr =
                        ZKUtil.readDataMaybeNull(
                                zkWatcher,
                                strBuff.append(groupCtrlRootDir)
                                        .append(TokenConstants.SLASH)
                                        .append(itemKey)
                                        .toString());
                strBuff.delete(0, strBuff.length());
                ...
                logger.error(
                        "KeeperException during load group control configure from ZooKeeper", e);
        ...
        logger.info(
                strBuff.append("[ZK Impl] loaded ")
                        .append(totalCnt)
                        .append(" group control configure successfully...")
                        .toString());
        strBuff.delete(0, strBuff.length());
    }
