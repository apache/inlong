...
public class MasterConfigTest {
    ...
    public void testMetaBdbConfig() throws Exception {
        ...
        Path configUrl =
                Paths.get(
                        Objects.requireNonNull(
                                        getClass()
                                                .getClassLoader()
                                                .getResource("master-meta-bdb.ini"))
                                .toURI());
        ...
        Assert.assertEquals(
                Durability.SyncPolicy.WRITE_NO_SYNC, repConfig.getMetaReplicaSyncPolicy());
        Assert.assertEquals(
                Durability.ReplicaAckPolicy.SIMPLE_MAJORITY, repConfig.getRepReplicaAckPolicy());
        ...
        Path configUrl =
                Paths.get(
                        Objects.requireNonNull(
                                        getClass()
                                                .getClassLoader()
                                                .getResource("master-meta-zk.ini"))
                                .toURI());
        masterConfig.loadFromFile(configUrl.toString());
    ...
    public void testNormalConfig() throws Exception {
        ...
        Assert.assertEquals(
                Durability.SyncPolicy.WRITE_NO_SYNC, repConfig.getMetaLocalSyncPolicy());
        ...
        Path configUrl =
                Paths.get(
                        Objects.requireNonNull(
                                        getClass()
                                                .getClassLoader()
                                                .getResource("master-replication-optional.ini"))
                                .toURI());
        masterConfig.loadFromFile(configUrl.toString());
        Assert.assertEquals(masterConfig.getMetaDataPath(), "var/meta_data");
        final BdbMetaConfig repConfig = masterConfig.getBdbMetaConfig();
                ...
                Paths.get(
                        Objects.requireNonNull(
                                        getClass()
                                                .getClassLoader()
                                                .getResource(
                                                        "master-replication-compatibility.ini"))
                                .toURI());
        masterConfig.loadFromFile(configUrl.toString());
