...
public class HeartbeatManagerTest {
    ...
    public void testBrokerTimeout() {
        ...
        Assert.assertTrue(
                heartbeatManager.getBrokerRegMap().get("node1").getTimeoutTime()
    ...
    public void testConsumerTimeout() {
        ...
        Assert.assertTrue(
                heartbeatManager.getConsumerRegMap().get("node1").getTimeoutTime()
                        > System.currentTimeMillis());
    }
    ...
    public void testProducerTimeout() {
        ...
        Assert.assertTrue(
                heartbeatManager.getProducerRegMap().get("node1").getTimeoutTime()
                        > System.currentTimeMillis());
    }
}
