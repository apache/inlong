...
public class ElasticsearchSinkExtrParamDTO {
    ...
    public static ElasticsearchSinkExtrParamDTO getFromJson(@NotNull String extParams) {
        if (StringUtils.isEmpty(extParams)) {
            return new ElasticsearchSinkExtrParamDTO();
        }
        try {
            OBJECT_MAPPER.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
            return OBJECT_MAPPER.readValue(extParams, ElasticsearchSinkExtrParamDTO.class);
        } catch (Exception e) {
