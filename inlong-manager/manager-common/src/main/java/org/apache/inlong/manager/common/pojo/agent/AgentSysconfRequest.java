...
/**
 * Request for obtaining agent system configuration information
 */
@ApiModel("Request for obtaining agent system configuration information")
@Data
public class AgentSysconfRequest {

    @ApiModelProperty(value = "Agent IP (IP obtained by confirmip)")
    private String agentIp;

    @ApiModelProperty(value = "MD5 of the existing configuration")
