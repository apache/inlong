...
public enum BizErrorCodeEnum {
    ...
    BUSINESS_BID_UPDATE_NOT_ALLOWED(1008, "The current business status does not support modifying the business ID"),
    ...
    DATA_STREAM_BID_UPDATE_NOT_ALLOWED(1204,
            "The current business status does not allow to modify the business ID of the data stream"),
    DATA_STREAM_ID_UPDATE_NOT_ALLOWED(1205, "The current business status does not allow to modify the data stream ID"),
