...
import org.apache.inlong.manager.pojo.sink.paimon.PaimonPartition;
...
/**
 * Test class for file to paimon.
 */
@Slf4j
@Disabled
public class File2PaimonExample extends BaseExample {

    @Test
    public void testCreateGroupForPaimon() {
        ...
        try {
            ...
            streamBuilder.sink(createPaimonSink());
     ...
     * Create Paimon sink
     */
    public PaimonSink createPaimonSink() {
        ...
        sink.setWarehouse("hdfs://{ip:port}/user/paimon/warehouse/");
        ...
        PaimonColumnInfo info1 = new PaimonColumnInfo();
        info1.setRequired(true);
        info1.setPartitionStrategy(PaimonPartition.BUCKET.toString());
        info1.setBucketNum(10);
        field1.setExtParams(JsonUtils.toJsonString(info1));

        // field3: decimal column example
        PaimonColumnInfo info3 = new PaimonColumnInfo();
        info3.setScale(5);
        ...
        PaimonColumnInfo info4 = new PaimonColumnInfo();
        info4.setPartitionStrategy(PaimonPartition.HOUR.toString());
