...
/**
 * Hudi source service test
 */
public class HudiSourceServiceTest extends ServiceBaseTest {
    ...
    public Integer saveSource() {
        ...
        HudiSourceRequest sourceInfo = new HudiSourceRequest();
        ...
        sourceInfo.setSourceType(SourceType.HUDI);
        sourceInfo.setPath("/tmp/inlong/hudi");
        sourceInfo.setTableType("COPY_ON_WRITE");
    ...
    public void testGetAndUpdate() {
        ...
        HudiSource hudiSource = (HudiSource)  response;
        HudiSourceRequest request = CommonBeanUtils.copyProperties(hudiSource, HudiSourceRequest::new);
