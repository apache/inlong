...
public class SQLServerJdbcUtils {
     ...
     *
     * @param url
     *          jdbc url, such as jdbc:sqlserver://host:port
     * @param user
     ...
     */
    public static void createTable(final Connection conn, final SQLServerTableInfo tableInfo) throws Exception {
