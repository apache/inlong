...
public class StreamTransformServiceImpl implements StreamTransformService {
    ...
    public void metaDeleteAll(String groupId, String streamId, String operator) {
        LOGGER.info("begin to delete all transform meta data for group={} stream={}", groupId, streamId);
        transformMapper.deleteByRelatedId(groupId, streamId);
        transformFieldMapper.deleteByRelatedId(groupId, streamId);
        LOGGER.info("finish delete all transform meta data for groupId={} stream={}", groupId, streamId);
    }
