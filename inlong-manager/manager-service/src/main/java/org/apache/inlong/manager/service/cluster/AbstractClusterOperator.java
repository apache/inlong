...
public abstract class AbstractClusterOperator implements InlongClusterOperator {
    ...
    @Autowired protected InlongClusterEntityMapper clusterMapper;

    @Override
    @Transactional(rollbackFor = Throwable.class)
    public Integer saveOpt(ClusterRequest request, String operator) {
        InlongClusterEntity entity =
                CommonBeanUtils.copyProperties(request, InlongClusterEntity::new);
        // set the ext params
    ...
    protected abstract void setTargetEntity(
            ClusterRequest request, InlongClusterEntity targetEntity);
