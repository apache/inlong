...
/**
 * Builder of drop ClickHouse table ddl
 */
public class ClickHouseDropTableSqlBuilder extends SqlBuilder<ClickHouseTableQueryBean> {

    @Override
    public String buildDDL(ClickHouseTableQueryBean table) {
        String dbTableName = "`" + table.getDbName() + "." + table.getTableName() + "`";
        ddl.append(" DROP TABLE IF EXISTS ").append(dbTableName);
        return ddl.toString();
    }

    @Override
    public String getOPT() {
        return "DROP_TABLE_CLICKHOUSE";
    }
}
