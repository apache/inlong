...
public class OperationLogPool {
    ...
    private static final ArrayBlockingQueue<OperationLogEntity> OPERATION_POOL =
    ...
    @Autowired private OperationLogEntityMapper operationLogEntityMapper;
    ...
    @PostConstruct
    public void init() {
        IntStream.range(0, THREAD_NUM).forEach(i -> executorService.submit(this::saveOperationLog));
    }
    ...
    private void saveOperationLog() {
        ...
        while (true) {
            ...
            try {
                ...
                log.info(
                        "receive {} logs and saved cost {} ms",
                        size,
