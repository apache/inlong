...
public class PostgresJdbcUtils {
    ...
    public static Connection getConnection(String url, String user, String password)
        ...
        try {
            ...
            String errorMsg = "get postgres connection error, please check postgres jdbc url, "
    ...
    /**
     * Execute One Postgres Sql command and return true or false as result
     */
    public static boolean executeSql(String sql, String url, String user, String password)
            throws Exception {
    ...
    /**
     * Execute One query Postgres Sql command and return ResultSet
     */
    ...
    public static boolean checkTablesExist(String url, String user, String password, String dbname,
        ...
        try (Connection conn = getConnection(url, user, password)) {
            ...
            rs = metaData.getTables(conn.getCatalog(), "public", tableName,
                    new String[]{"TABLE"});
            if (rs != null) {
                rs.next();
                result = (rs != null && rs.getRow() > 0
                        && tableName.equals(rs.getString(COLUMN_LABEL)));
                LOG.info("dbname is dbname = {}, tableName = {}, result = {}", dbname, tableName,
                        result);
            }
        }
        return result;
     ...
     */
    public static List<PostgresColumnInfo> getColumns(String url, String user, String password,
            String tableName) throws Exception {
