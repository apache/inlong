...
/**
 * The utility of paimon.
 */
public class PaimonUtils {

    private static final String COMMIT_TIME_METADATA_FILE_NAME = "_Paimon_commit_time";
    private static final String COMMIT_SEQNO_METADATA_FILE_NAME = "_Paimon_commit_seqno";
    private static final String RECORD_KEY_METADATA_FILE_NAME = "_Paimon_record_key";
    private static final String PARTITION_PATH_METADATA_FILE_NAME = "_Paimon_partition_path";
    private static final String METADATA_FILE_NAME = "_Paimon_file_name";
    private static final String OPERATION_METADATA_FILE_NAME = "_Paimon_operation";
    ...
    private static final String PARQUET_REALTIME_INPUT_FORMAT_NAME =
            "org.apache.paimon.hadoop.realtime.PaimonParquetRealtimeInputFormat";
    private static final String PARQUET_INPUT_FORMAT_NAME = "org.apache.paimon.hadoop.PaimonParquetInputFormat";
    private static final String HFILE_REALTIME_INPUT_FORMAT_NAME =
            "org.apache.paimon.hadoop.realtime.PaimonHFileRealtimeInputFormat";
    private static final String HFILE_INPUT_FORMAT_NAME = "org.apache.paimon.hadoop.PaimonHFileInputFormat";
     ...
     */
    public static String getInputFormatClassName(PaimonFileFormat baseFileFormat, boolean realtime) {
        switch (baseFileFormat) {
            ...
            default:
                throw new RuntimeException("Paimon InputFormat not implemented for base file format " + baseFileFormat);
        }
    }
     ...
     */
    public static String getOutputFormatClassName(PaimonFileFormat baseFileFormat) {
        switch (baseFileFormat) {
            case PARQUET:
            case HFILE:
     ...
     */
    public static String getSerDeClassName(PaimonFileFormat baseFileFormat) {
        switch (baseFileFormat) {
            case PARQUET:
            case HFILE:
