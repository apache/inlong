...
/**
 * The listener of Inlong cluster when created resources failed.
 */
@Slf4j
@Component
public class InitClusterFailedListener implements ProcessEventListener {
    ...
    public ListenerResult listen(WorkflowContext context) throws WorkflowListenerException {
        ...
        log.info("Init cluster failed for cluster tag={}", clusterProcessForm.getInlongClusterTag());
