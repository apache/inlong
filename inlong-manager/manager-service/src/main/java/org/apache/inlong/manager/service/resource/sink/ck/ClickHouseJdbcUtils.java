...
public class ClickHouseJdbcUtils {
    ...
    public static Connection getConnection(String url, String user, String password)
        ...
        if (StringUtils.isBlank(url) || !url.startsWith(CLICKHOUSE_JDBC_PREFIX)) {
            throw new Exception(
                    "ClickHouse server URL was invalid, it should start with jdbc:clickhouse");
        }
        Connection conn;
        try {
            ...
            LOG.error(
                    "get clickhouse connection error, please check clickhouse jdbc url, username or password",
                    e);
            throw new Exception(
                    "get clickhouse connection error, please check jdbc url, username or password. "
                            + "other error msg: "
                            + e.getMessage());
        }
    ...
    public static void createTable(
            String url, String user, String password, ClickHouseTableInfo tableInfo)
            throws Exception {
    ...
    public static List<ClickHouseColumnInfo> getColumns(
