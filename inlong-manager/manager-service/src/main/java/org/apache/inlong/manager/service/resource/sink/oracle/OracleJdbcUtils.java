...
public class OracleJdbcUtils {
     ...
     *
     * @param url jdbc url,such as jdbc:oracle:thin@host:port:sid or
    ...
    public static Connection getConnection(
        ...
        try {
            ...
            final String errorMsg =
                    "get Oracle connection error, please check Oracle JDBC url, username or password!";
     ...
     */
    public static void createTable(final Connection conn, final OracleTableInfo tableInfo)
            throws Exception {
    ...
    public static boolean checkTablesExist(
            final Connection conn, final String userName, final String tableName) throws Exception {
        ...
        LOG.info(
                "check table exist for username={} table={}, result={}",
                userName,
                tableName,
                result);
        return result;
     ...
     */
    public static boolean checkColumnExist(
            final Connection conn, final String tableName, final String column) throws Exception {
        boolean result = false;
        ...
        LOG.info(
                "check column exist for table={}, column={}, result={}", tableName, column, result);
        return result;
    }
     ...
     */
    public static List<OracleColumnInfo> getColumns(final Connection conn, final String tableName)
            throws Exception {
        ...
        try (Statement stmt = conn.createStatement();
            ...
            while (rs.next()) {
                OracleColumnInfo columnInfo =
                        new OracleColumnInfo(rs.getString(1), rs.getString(2), rs.getString(3));
    ...
    public static void addColumns(
            final Connection conn, final String tableName, final List<OracleColumnInfo> columns)
            throws Exception {
