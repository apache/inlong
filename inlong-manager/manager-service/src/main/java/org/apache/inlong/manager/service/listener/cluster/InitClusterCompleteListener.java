...
/**
 * The listener of Inlong cluster when created resources successfully.
 */
@Slf4j
@Component
public class InitClusterCompleteListener implements ProcessEventListener {
    ...
    public ListenerResult listen(WorkflowContext context) throws WorkflowListenerException {
        ...
        log.info("Init cluster complete for cluster tag={}", clusterProcessForm.getInlongClusterTag());
