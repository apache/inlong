...
(
    ...
    `report_data_to`         int(4)                DEFAULT '0' COMMENT 'the reporting position of the collection task corresponding to the groupId, 0: to DataProxy with source response, 1: to DataProxy with sink response, 2: to MQ directly',
