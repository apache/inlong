...
(
    ...
    `mq_resource`            varchar(128) NOT NULL COMMENT 'MQ resource, for Tube, its Topic, for Pulsar, Namespace/Topic',
    ...
    `ext_params`             text              DEFAULT NULL COMMENT 'Extended params, will saved as JSON string, such as queue_module, partition_num,',
...
(
    ...
    `data_source_type`       varchar(32)       DEFAULT 'FILE' COMMENT 'Data source type, including: FILE, BINLOG, AUTO_PUSH, etc.',
