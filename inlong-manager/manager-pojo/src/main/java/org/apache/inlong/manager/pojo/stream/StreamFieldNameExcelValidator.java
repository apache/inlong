 ...
 */
public class StreamFieldNameExcelValidator implements ExcelCellValidator<String> {

    /**
     * Constructor for StreamFieldNameExcelValidator.
     */
    public StreamFieldNameExcelValidator() {
    }
