...
public class RedisColumnInfo extends SinkField {
     ...
     */
    public static RedisColumnInfo getFromRequest(SinkField sinkField) {
        return CommonBeanUtils.copyProperties(sinkField, RedisColumnInfo::new, true);
    }

    /**
     * Get the extra param from the Json
     */
    public static RedisColumnInfo getFromJson(@NotNull String extParams) {
        if (StringUtils.isEmpty(extParams)) {
            return new RedisColumnInfo();
        }
        try {
