...
public class HudiSinkDTO {
    ...
    public static HudiTableInfo getHudiTableInfo(HudiSinkDTO hudiInfo, List<HudiColumnInfo> columnList) {
        HudiTableInfo info = new HudiTableInfo();
        info.setDbName(hudiInfo.getDbName());
        info.setTableName(hudiInfo.getTableName());
        info.setFileFormat(hudiInfo.getFileFormat());
        info.setTblProperties(hudiInfo.getProperties());
