...
/**
 * Inlong group switch info
 */
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
@ApiModel("Inlong group switch info")
public class InlongGroupSwitchDTO {
    ...
    public static InlongGroupSwitchDTO getFromJson(@NotNull String extParams) {
        try {
            return JsonUtils.parseObject(extParams, InlongGroupSwitchDTO.class);
        } catch (Exception e) {
