...
public class OceanBaseBinlogSourceDTO {
    ...
    @ApiModelProperty("Id of physical node of OceanBase Cluster, 0 if single node")
    @Builder.Default
     ...
     */
    public static OceanBaseBinlogSourceDTO getFromRequest(OceanBaseBinlogSourceRequest request, String extParams) {
    ...
    public static OceanBaseBinlogSourceDTO getFromJson(@NotNull String extParams) {
        try {
            return JsonUtils.parseObject(extParams, OceanBaseBinlogSourceDTO.class);
        } catch (Exception e) {
            throw new BusinessException(ErrorCodeEnum.SOURCE_INFO_INCORRECT,
                    String.format("parse extParams of OceanBaseBinlogSource failure: %s", e.getMessage()));
        }
    }
