...
sed -i "s/apache_inlong_manager/${MANAGER_TABLE}/g" "${conf_file}"
# for data cleansing
...
sed -i "s/apache_inlong_audit/${AUDIT_CK_TABLE}/g" "${conf_file}"
...
# for db sql
sed -i "s/apache_inlong_manager/${MANAGER_TABLE}/g" "${sql_file}"
