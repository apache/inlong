...
class WorkflowApproverClientTest extends ClientFactoryTest {
    ...
    private static final WorkflowApproverClient workflowApproverClient =
            clientFactory.getWorkflowApproverClient();
    ...
    void testListByCondition() {
        ...
        ApproverPageRequest request =
                ApproverPageRequest.builder().processName("process1").approver("user1").build();
        request.setPageNum(1);
        request.setPageSize(10);

        List<ApproverResponse> approverResponseList =
                workflowApproverClient.listByCondition(request);
