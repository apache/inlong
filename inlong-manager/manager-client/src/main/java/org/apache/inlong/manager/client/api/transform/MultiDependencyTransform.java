...
public class MultiDependencyTransform extends StreamTransform {
     ...
     * @param preNodes name of pre streamNodes, if pre streamNode is streamSource, then preNode is
     *     sourceName if pre streamNode is streamTransform, preNode is transformName
     */
    public MultiDependencyTransform(
            String transformName, TransformDefinition transformDefinition, String... preNodes) {
     ...
     * @param preNodes name of pre streamNodes, if pre streamNode is streamSource, then preNode is
     *     sourceName if pre streamNode is streamTransform, preNode is transformName
     * @param postNodes postNodes name of post streamNode, if post streamNode is streamSource, then
     *     postNode is sourceName, if post streamNode is streamTransform, postNode is transformName
     */
    public MultiDependencyTransform(
            String transformName,
            TransformDefinition transformDefinition,
            List<String> preNodes,
            List<String> postNodes) {
