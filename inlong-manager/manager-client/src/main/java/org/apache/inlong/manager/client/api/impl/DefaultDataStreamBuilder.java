...
import org.apache.inlong.manager.client.api.DataSource;
import org.apache.inlong.manager.client.api.DataStorage;
...
public class DefaultDataStreamBuilder extends DataStreamBuilder {
    ...
    @Override
    public DataStreamBuilder source(DataSource source) {
        return this;
    }

    @Override
    public DataStreamBuilder sink(DataStorage storage) {
        return this;
    }
