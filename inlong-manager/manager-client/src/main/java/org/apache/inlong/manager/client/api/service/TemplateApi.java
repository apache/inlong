...
public interface TemplateApi {
    ...
    @GET("template/get")
    Call<Response<TemplateInfo>> get(@Query("templateName") String templateName);

    @POST("template/list")
    Call<Response<PageResult<TemplateInfo>>> listByCondition(@Body TemplatePageRequest request);
