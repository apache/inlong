...
public class EventListenerServiceImpl implements EventListenerService {
    ...
    public void executeEventListener(Integer eventLogId) {
        ...
        if (ProcessEvent.class.getSimpleName().equals(eventLogEntity.getEventType())) {
            this.executeProcessEventListener(
                    eventLogEntity.getProcessId(), eventLogEntity.getListener());
            return;
        }
    ...
    public void executeProcessEventListener(Integer processId, String listenerName) {
        ...
        ProcessEvent processEvent =
                getProcessEventListener(context.getProcess(), listenerName).event();
    ...
    public void executeTaskEventListener(Integer taskId, String listenerName) {
        ...
        TaskEventListener eventListener =
                getTaskEventListener((WorkflowTask) context.getCurrentElement(), listenerName);
    ...
    public void triggerTaskEvent(Integer taskId, TaskEvent taskEvent) {
        WorkflowContext context =
                workflowContextBuilder.buildContextForTask(
                        taskId, WorkflowAction.fromTaskEvent(taskEvent));
    ...
    private ProcessEventListener getProcessEventListener(
            WorkflowProcess process, String listenerName) {
