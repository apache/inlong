...
(
    ...
    `field_format`        text  DEFAULT NULL COMMENT 'including: MICROSECONDS, MILLISECONDS, SECONDS, SQL, ISO_8601, custom such as yyyy-MM-dd HH:mm:ss, serialize format of complex type, serialize format of decimal precision',
...
(
    ...
    `is_meta_field`    smallint(3)  DEFAULT '0' COMMENT 'Is this field a meta field? 0: no, 1: yes',
    `meta_field_name`  varchar(120)  DEFAULT NULL COMMENT 'Meta field name',
    `field_format`     text  DEFAULT NULL COMMENT 'including: MICROSECONDS, MILLISECONDS, SECONDS, SQL, ISO_8601 and custom such as yyyy-MM-dd HH:mm:ss, serialize format of complex type, serialize format of decimal precision',
    `rank_num`         smallint(6)  DEFAULT '0' COMMENT 'Field order (front-end display field order)',
    `is_deleted`       int(11)      DEFAULT '0' COMMENT 'Whether to delete, 0: not deleted, > 0: deleted',
    PRIMARY KEY (`id`),
