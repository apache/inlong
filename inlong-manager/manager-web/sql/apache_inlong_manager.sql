...
(
    ...
    `back_mq_resource`          varchar(128)          DEFAULT NULL COMMENT 'Backup mq resource, used to switch cluster',
    ...
    `backup_inlong_cluster_tag` varchar(128)          DEFAULT NULL COMMENT 'Backup cluster tag, used to switch cluster',
...
(
    ...
    `backup_mq_resource` varchar(128)          DEFAULT NULL COMMENT 'Backup MQ resource, used to switch cluster',
