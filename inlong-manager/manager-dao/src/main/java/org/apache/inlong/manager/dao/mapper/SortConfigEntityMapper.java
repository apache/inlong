...
public interface SortConfigEntityMapper {
    ...
    int insert(SortConfigEntity record);

    SortConfigEntity selectByPrimaryKey(Integer id);

    SortConfigEntity selectBySinkId(@Param("sinkId") Integer sinkId);

    int updateByIdSelective(SortConfigEntity record);
