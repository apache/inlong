...
export default class PaimonSink extends SinkInfo implements DataWithBackend, RenderRow, RenderList {
  @FieldDecorator({
    type: 'input',
    rules: [{ required: true }],
    props: values => ({
  ...
  @ColumnDecorator()
  @I18n('meta.Sinks.Paimon.TableName')
  @SyncField()
  @IngestionField()
  tableName: string;
  ...
  @ColumnDecorator()
  @I18n('meta.Sinks.Paimon.FileFormat')
  @SyncField()
  @IngestionField()
  fileFormat: string;
  ...
  @FieldDecorator({
    ...
    initialValue: [],
    tooltip: i18n.t('meta.Sinks.Paimon.ExtListHelper'),
    props: values => ({
      size: 'small',
      columns: [
        {
  ...
  @SyncField()
  @IngestionField()
  @I18n('meta.Sinks.Paimon.ExtList')
  extList: string;
  ...
  @SyncField()
  @IngestionField()
  @I18n('meta.Sinks.Paimon.DataConsistency')
  ...
  @FieldDecorator({
    type: 'input',
    tooltip: i18n.t('meta.Sinks.Paimon.PrimaryKeyHelper'),
    props: values => ({
      disabled: [110].includes(values?.status),
    }),
  })
  ...
  @SyncField()
  @IngestionField()
  @I18n('meta.Sinks.Paimon.PrimaryKey')
  primaryKey: string;

  @FieldDecorator({
    type: 'input',
    tooltip: i18n.t('meta.Sinks.Paimon.PartitionKeyHelper'),
    rules: [{ required: false }],
    props: values => ({
      disabled: [110].includes(values?.status),
    }),
  ...
  @SyncField()
  @IngestionField()
  @I18n('meta.Sinks.Paimon.PartitionKey')
  partitionKey: string;
}
