    ...
    <>
      {openT.open ? (
        ...
        <Row gutter={[40, 48]}>
          ...
          <Col span={2} onDoubleClick={openClick} style={{position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
            <a type="link" style={{ position: 'absolute', display: 'flex', alignItems: 'center', justifyContent:'center' }}>
              <Button type="link">
