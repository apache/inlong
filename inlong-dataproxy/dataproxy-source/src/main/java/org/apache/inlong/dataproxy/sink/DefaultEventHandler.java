...
public class DefaultEventHandler implements EventHandler {
     ...
     */
    @Override
    public Map<String, String> parseHeader(IdTopicConfig idConfig, DispatchProfile profile, String nodeId,
     ...
     */
    @Override
    public byte[] parseBody(IdTopicConfig idConfig, DispatchProfile profile, INLONG_COMPRESSED_TYPE compressType)
            throws IOException {
