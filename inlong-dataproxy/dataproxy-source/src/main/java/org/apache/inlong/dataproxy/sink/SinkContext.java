...
public class SinkContext {
     ...
     * @return
     */
    public static BufferQueue<DispatchProfile> createBufferQueue() {
        int maxBufferQueueSizeKb = CommonPropertiesHolder.getInteger(KEY_MAX_BUFFERQUEUE_SIZE_KB,
                DEFAULT_MAX_BUFFERQUEUE_SIZE_KB);
        BufferQueue<DispatchProfile> dispatchQueue = new BufferQueue<DispatchProfile>(maxBufferQueueSizeKb);
