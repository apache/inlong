...
public class ConfigConstants {
    ...
    // Source config
    public static final String CLICKHOUSE_DRIVER = "clickhouse.driver";
    ...
    // Time config
    public static final String QUERY_SQL_TIME_OUT = "query.sql.timeout";
    public static final int DEFAULT_QUERY_SQL_TIME_OUT = 300;
    public static final String JDBC_TIME_OUT = "jdbc.timeout.second";
    public static final int DEFAULT_JDBC_TIME_OUT = 300;
    public static final String DATASOURCE_CONNECTION_TIMEOUT = "datasource.connection.timeout.ms";
    public static final int DEFAULT_CONNECTION_TIMEOUT = 1000 * 60 * 5;
    public static final String API_RESPONSE_TIMEOUT = "api.response.timeout";
    public static final int DEFAULT_API_TIMEOUT = 30;
    public static final String QUEUE_PULL_TIMEOUT = "queue.pull.timeout.ms";
    public static final int DEFAULT_QUEUE_PULL_TIMEOUT = 1000;

    // Interval config
    public static final String SOURCE_CLICKHOUSE_STAT_INTERVAL = "source.clickhouse.stat.interval.minute";
    public static final int DEFAULT_SOURCE_CLICKHOUSE_STAT_INTERVAL = 1;
    public static final String SOURCE_DB_STAT_INTERVAL = "source.db.stat.interval.minute";
    public static final int DEFAULT_SOURCE_DB_STAT_INTERVAL = 1;
    public static final String SOURCE_DB_SINK_INTERVAL = "sink.db.interval.ms";
    public static final int DEFAULT_SOURCE_DB_SINK_INTERVAL = 100;
    public static final String SOURCE_DB_SINK_BATCH = "sink.db.batch";
    public static final int DEFAULT_SOURCE_DB_SINK_BATCH = 1000;
    public static final String SOURCE_DB_SINK_INTERNAL = "sink.db.internal.ms";
    public static final int DEFAULT_SOURCE_DB_SINK_INTERNAL = 100;

    // Api config
    public static final String HOUR_API_PATH = "hour.api.path";
    public static final String DEFAULT_HOUR_API_PATH = "/audit/query/hour";
    public static final String DAY_API_PATH = "day.api.path";
    public static final String DEFAULT_DAY_API_PATH = "/audit/query/day";
    public static final String DAY_API_TABLE = "day.api.table";
    public static final String DEFAULT_DAY_API_TABLE = "audit_data_day";
    public static final String MINUTE_API_TABLE = "minute.api.table";
    public static final String DEFAULT_MINUTE_API_TABLE = "audit_data_temp";
    public static final String MINUTE_10_API_PATH = "minute.10.api.path";
    public static final String DEFAULT_MINUTE_10_API_PATH = "/audit/query/minute/10";
    public static final String MINUTE_30_API_PATH = "minute.30.api.path";
    public static final String DEFAULT_MINUTE_30_API_PATH = "/audit/query/minute/30";
    public static final String API_POOL_SIZE = "api.pool.size";
    public static final int DEFAULT_POOL_SIZE = 10;
    public static final String API_BACKLOG_SIZE = "api.backlog.size";
    ...
    public static final String AUDIT_IDS = "audit.ids";
    public static final String DEFAULT_AUDIT_IDS = "3;4;5;6";

    // Summary config
    public static final String REALTIME_SUMMARY_SOURCE_TABLE = "realtime.summary.source.table";
    public static final String DEFAULT_REALTIME_SUMMARY_SOURCE_TABLE = "audit_data";
    public static final String REALTIME_SUMMARY_SINK_TABLE = "realtime.summary.sink.table";
    public static final String DEFAULT_REALTIME_SUMMARY_SINK_TABLE = "audit_data_temp";
    public static final String REALTIME_SUMMARY_BEFORE_TIMES = "realtime.summary.before.times";
    public static final int DEFAULT_REALTIME_SUMMARY_BEFORE_TIMES = 6;

    public static final String DAILY_SUMMARY_SOURCE_TABLE = "daily.summary.source.table";
    public static final String DEFAULT_DAILY_SUMMARY_SOURCE_TABLE = "audit_data_temp";
    public static final String DAILY_SUMMARY_SINK_TABLE = "daily.summary.sink.table";
    public static final String DEFAULT_DAILY_SUMMARY_SINK_TABLE = "audit_data_day";
    public static final String DAILY_SUMMARY_BEFORE_TIMES = "daily.summary.before.times";
