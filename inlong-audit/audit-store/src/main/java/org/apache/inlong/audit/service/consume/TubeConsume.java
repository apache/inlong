...
public class TubeConsume extends BaseConsume {
    ...
    public void start() {
        ...
        Preconditions.checkArgument(
                StringUtils.isNotEmpty(masterUrl), "no tube masterUrlList specified");
        ...
        Preconditions.checkArgument(
                StringUtils.isNotEmpty(mqConfig.getTubeConsumerGroupName()),
        ...
        for (int i = 0; i < fetchThreadCnt; i++) {
            fetchRunners[i] =
                    new Thread(new Fetcher(pullConsumer, topic), "TubeConsume_Fetcher_Thread_" + i);
    ...
    private void initConsumer() {
        ...
        ConsumerConfig consumerConfig =
                new ConsumerConfig(masterUrl, mqConfig.getTubeConsumerGroupName());
    ...
    public class Fetcher implements Runnable {
        ...
        public void run() {
            ...
            while (true) {
                if (pullMessageConsumer.isPartitionsReady(5000)
                        || pullMessageConsumer.isShutdown()) {
            ...
            while (true) {
                ...
                try {
                    ...
                    if (csmResult.isSuccess()) {
                        ...
                        LOG.error(
                                "receive messages errorCode is {}, error meddage is {}",
