...
public class ManagerUrlHandler {
    ...
    private static final Logger LOG =
            InlongLoggerFactory.getLogger(org.apache.inlong.sort.standalone.config.holder.ManagerUrlHandler.class);
    private static final String KEY_MANAGER_URL_LOADER_TYPE = "UCManagerUrlLoaderType";
