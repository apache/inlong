...
public class TestEsCallbackListener {
    ...
    public void testAfterSuccessBulk() throws Exception {
        ...
        BulkItemResponse.Failure failure =
                new BulkItemResponse.Failure("index", OpType.INDEX.name(), "id", new Exception());
        BulkItemResponse failResponse = new BulkItemResponse(0, OpType.INDEX, failure);
        responses[0] = failResponse;
        listener.afterBulk(executionId, bulkRequest, bulkResponse);

        // failNull noResend
        BulkItemResponse.Failure failureNull =
                new BulkItemResponse.Failure("index", OpType.INDEX.name(), "id", null);
