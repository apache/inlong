...
public final class SortSdkSourceContext extends SourceContext {
     ...
     *
     * <p>For {@link SortSdkSource}, there are only two types of fetch results, success or failure.
     */
    ...
    public void reportToMetric(
            ...
            @NotNull(message = "Must specify fetch result")
                    final SortSdkSourceContext.FetchResult fetchResult) {

        final Map<String, String> dimensions =
                this.createSortSdkSourceDimensionMap(event, sortId, topic);
     ...
     *
     * <p>For the case of fetch {@link FetchResult#FAILURE}, the event may be null, the {@link
     * org.apache.inlong.sort.standalone.utils.Constants#INLONG_GROUP_ID} and the {@link
     * org.apache.inlong.sort.standalone.utils.Constants#INLONG_STREAM_ID} will not be specified.
     *
    ...
    private Map<String, String> createSortSdkSourceDimensionMap(
            final ProfileEvent event, final String sortId, final String topic) {
