...
public class PulsarIdConfig {
    ...
    public PulsarIdConfig(Map<String, String> idParam) {
        ...
        this.separator =
                idParam.getOrDefault(
                        PulsarIdConfig.KEY_SEPARATOR, PulsarIdConfig.DEFAULT_SEPARATOR);
        this.topic = idParam.getOrDefault(Constants.TOPIC, uid);
        this.dataType =
                DataType.convert(
                        idParam.getOrDefault(PulsarIdConfig.KEY_DATA_TYPE, DataType.TEXT.value()));
    }
