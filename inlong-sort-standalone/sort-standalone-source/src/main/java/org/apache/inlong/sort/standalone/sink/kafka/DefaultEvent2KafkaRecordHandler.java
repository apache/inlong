...
public class DefaultEvent2KafkaRecordHandler implements IEvent2KafkaRecordHandler {
     ...
     */
    @Override
    public ProducerRecord<String, byte[]> parse(
            KafkaFederationSinkContext context, ProfileEvent event) throws IOException {
        ...
        ProducerRecord<String, byte[]> record =
                new ProducerRecord<>(idConfig.getTopic(), msgContent);
        return record;
    }
