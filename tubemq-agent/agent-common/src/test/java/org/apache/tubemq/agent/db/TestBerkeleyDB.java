...
public class TestBerkeleyDB {
    private static final Logger LOGGER = LoggerFactory.getLogger(TestBerkeleyDB.class);

    private static BerkeleyDB db;

    @BeforeClass
    public static void setup() throws Exception {
        AgentBaseTestsHelper.setupAgentHome();
        db = new BerkeleyDB();
    }
    ...
    public static void teardown() throws Exception {
        db.close();
        AgentBaseTestsHelper.teardownAgentHome();
    }
