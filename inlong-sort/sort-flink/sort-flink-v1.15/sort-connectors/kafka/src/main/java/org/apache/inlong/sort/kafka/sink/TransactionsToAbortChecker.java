...
class TransactionsToAbortChecker {
    ...
    public List<String> getTransactionsToAbort(Map<Integer, Map<Long, String>> openTransactions) {
        ...
        for (final Map.Entry<Integer, Map<Long, String>> subtaskOffsetMapping : openTransactions.entrySet()) {
            ...
            if (Collections.min(checkpointOffsetTransactionalIdMapping.keySet()) == MINIMUM_CHECKPOINT_OFFSET
                ...
                for (final Map.Entry<Long, String> offsetTransactionId : checkpointOffsetTransactionalIdMapping
                        .entrySet()) {
