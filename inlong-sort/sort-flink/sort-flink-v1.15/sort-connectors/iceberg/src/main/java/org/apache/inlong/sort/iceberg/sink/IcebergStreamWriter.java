...
class IcebergStreamWriter<T> extends AbstractStreamOperator<WriteResult>
    ...
    private final SinkMetadataUtils sinkMetadataUtils;
    ...
    IcebergStreamWriter(String fullTableName, TaskWriterFactory<T> taskWriterFactory,
            SinkMetadataUtils sinkMetadataUtils, MetricOption metricOption) {
    ...
    public void open() {
        ...
        this.writerMetrics.registerMetrics(metricOption);
    ...
    public void processElement(StreamRecord<T> element) throws Exception {
        ...
        writerMetrics.outputMetricsWithEstimate(sinkMetadataUtils.getDataSize(data),
                sinkMetadataUtils.getDataTime(data));
        writer.write(data);
    }
