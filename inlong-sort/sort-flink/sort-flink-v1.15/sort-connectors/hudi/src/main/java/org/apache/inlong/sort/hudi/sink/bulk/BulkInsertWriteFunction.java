...
public class BulkInsertWriteFunction<I>
     ...
     */
    public BulkInsertWriteFunction(Configuration config, RowType rowType, MetricOption metricOption) {
        this.config = config;
    ...
    private void initWriterHelper() {
        ...
        this.writerHelper = WriterHelpers.getWriterHelper(this.config, this.writeClient.getHoodieTable(),
