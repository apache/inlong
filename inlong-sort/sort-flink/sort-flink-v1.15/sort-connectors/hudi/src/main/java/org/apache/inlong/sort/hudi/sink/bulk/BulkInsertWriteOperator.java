...
public class BulkInsertWriteOperator<I>
    ...
    public BulkInsertWriteOperator(Configuration conf, RowType rowType, MetricOption metricOption) {
    ...
    public static <I> WriteOperatorFactory<I> getFactory(Configuration conf, RowType rowType,
        ...
        return WriteOperatorFactory.instance(conf, new BulkInsertWriteOperator<>(conf, rowType, metricOption));
    }
}
