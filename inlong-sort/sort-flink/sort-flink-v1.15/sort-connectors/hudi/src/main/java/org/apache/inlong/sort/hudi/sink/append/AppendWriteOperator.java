...
public class AppendWriteOperator<I> extends AbstractWriteOperator<I> {
    ...
    public AppendWriteOperator(Configuration conf, RowType rowType, MetricOption metricOption) {
    ...
    public static <I> WriteOperatorFactory<I> getFactory(Configuration conf, RowType rowType,
        ...
        return WriteOperatorFactory.instance(conf, new AppendWriteOperator<>(conf, rowType, metricOption));
    }
}
