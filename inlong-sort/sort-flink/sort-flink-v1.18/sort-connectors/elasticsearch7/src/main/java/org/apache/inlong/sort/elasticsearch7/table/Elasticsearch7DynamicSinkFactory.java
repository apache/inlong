...
import static org.apache.flink.streaming.connectors.elasticsearch.table.ElasticsearchConnectorOptions.*;
...
public class Elasticsearch7DynamicSinkFactory implements DynamicTableSinkFactory {
    ...
    private static final String IDENTIFIER = "elasticsearch7-inlong";
