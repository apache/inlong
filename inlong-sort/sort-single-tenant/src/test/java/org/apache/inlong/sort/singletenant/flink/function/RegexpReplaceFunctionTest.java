...
public class RegexpReplaceFunctionTest extends AbstractTestBase {
    ...
    public void testRegexpReplace() throws Exception {
        ...
        RegexpReplaceFunction splitIndexFunction = new RegexpReplaceFunction(new FieldInfo("f1",
                new StringFormatInfo()), new StringConstantParam("inlong*"), new StringConstantParam("INLONG"));
