...
public class FlinkSink {
    ...
    public static class Builder {
         ...
         * @deprecated this will be removed in 0.14.0; use {@link #append()} because its returned
         *     {@link DataStreamSink} has a more correct data type.
         */
        @Deprecated
        ...
        private SingleOutputStreamOperator<Void> appendCommitter(
            ...
            IcebergFilesCommitter filesCommitter =
                    new IcebergFilesCommitter(tableLoader, overwrite);
            SingleOutputStreamOperator<Void> committerStream =
                    writerStream
                            .transform(
        ...
        private SingleOutputStreamOperator<WriteResult> appendWriter(
            ...
            // Fallback to use upsert mode parsed from table properties if don't specify in job
            // level.
            boolean upsertMode =
                    upsert
        ...
        private DataStream<RowData> distributeDataStream(
            ...
            if (distributionMode == null) {
                // Fallback to use distribution mode parsed from table properties if don't specify
                // in job level.
                String modeName =
            ...
            switch (writeMode) {
                ...
                default:
                    throw new RuntimeException(
                            "Unrecognized write.distribution-mode: " + writeMode);
            }
        }
    }
    ...
    static RowType toFlinkRowType(Schema schema, TableSchema requestedSchema) {
        if (requestedSchema != null) {
            ...
            // to iceberg INTEGER, that means if we use iceberg's table schema to read TINYINT
            // (backend by 1 'byte'),
