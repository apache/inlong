...
package org.apache.inlong.sort.elasticsearch5.table;
...
import org.apache.inlong.sort.elasticsearch5.ElasticsearchSink;
 ...
 */
@PublicEvolving
final class Elasticsearch5DynamicSink implements DynamicTableSink {

    @VisibleForTesting
    static final Elasticsearch5RequestFactory REQUEST_FACTORY = new Elasticsearch5RequestFactory();

    private final EncodingFormat<SerializationSchema<RowData>> format;
    private final TableSchema schema;
    private final Elasticsearch5Configuration config;
    ...
    public Elasticsearch5DynamicSink(
            EncodingFormat<SerializationSchema<RowData>> format,
            Elasticsearch5Configuration config,
            TableSchema schema,
            String inlongMetric,
    ...
    public boolean equals(Object o) {
        ...
        Elasticsearch5DynamicSink that = (Elasticsearch5DynamicSink) o;
    ...
    interface ElasticSearchBuilderProvider {
        ...
        ElasticsearchSink.Builder<RowData> createBuilder(
                List<InetSocketAddress> transportAddresses, RowElasticsearchSinkFunction upsertSinkFunction);
    }
     ...
     * sink.
     */
    private static class Elasticsearch5RequestFactory implements RequestFactory {
