...
/**
 * A {@link DynamicTableSinkFactory} for discovering {@link Elasticsearch5DynamicSink}.
 */
@Internal
public class Elasticsearch5DynamicSinkFactory implements DynamicTableSinkFactory {
    ...
    public DynamicTableSink createDynamicTableSink(Context context) {
        ...
        Elasticsearch5Configuration config =
                new Elasticsearch5Configuration(configuration, context.getClassLoader());
        ...
        return new Elasticsearch5DynamicSink(
                format, config, TableSchemaUtils.getPhysicalSchema(tableSchema), inlongMetric, auditHostAndPorts);
    }

    private void validate(Elasticsearch5Configuration config, Configuration originalConfiguration) {
