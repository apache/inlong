...
public class HiveOptions {
    ...
    public static final ConfigOption<String> HIVE_DATABASE = ConfigOptions.key("hive-database")
            .stringType()
            .noDefaultValue()
            .withDescription("The name of hive database to connect.");

    public static final ConfigOption<Boolean> TABLE_EXEC_HIVE_FALLBACK_MAPRED_READER = key(
    ...
    public static final ConfigOption<Boolean> TABLE_EXEC_HIVE_INFER_SOURCE_PARALLELISM = key(
    ...
    public static final ConfigOption<Integer> TABLE_EXEC_HIVE_INFER_SOURCE_PARALLELISM_MAX = key(
            "table.exec.hive.infer-source-parallelism.max")
                    .defaultValue(1000)
                    .withDescription("Sets max infer parallelism for source operator.");

    public static final ConfigOption<Boolean> TABLE_EXEC_HIVE_FALLBACK_MAPRED_WRITER = key(
    ...
    public static final ConfigOption<Boolean> HIVE_IGNORE_ALL_CHANGELOG = ConfigOptions.key("sink.ignore.changelog")
            .booleanType()
            .defaultValue(false)
