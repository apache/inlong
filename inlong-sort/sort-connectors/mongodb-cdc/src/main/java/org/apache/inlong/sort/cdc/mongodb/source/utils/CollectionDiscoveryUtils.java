...
public class CollectionDiscoveryUtils {
    ...
    public static Predicate<String> databaseFilter(List<String> databaseList) {
        Predicate<String> databaseFilter =
                com.ververica.cdc.connectors.mongodb.source.utils.CollectionDiscoveryUtils::isNotBuiltInDatabase;
    ...
    public static Predicate<String> collectionsFilter(List<String> collectionList) {
        Predicate<String> collectionFilter =
                com.ververica.cdc.connectors.mongodb.source.utils.CollectionDiscoveryUtils::isNotBuiltInCollections;
    ...
    public static Pattern includeListAsFlatPattern(List<String> includeList) {
        return includeListAsFlatPattern(includeList,
                com.ververica.cdc.connectors.mongodb.source.utils.CollectionDiscoveryUtils::completionPattern);
    }
    ...
    public static List<Pattern> includeListAsPatterns(List<String> includeList) {
        ...
        return includeListAsPatterns(includeList,
                com.ververica.cdc.connectors.mongodb.source.utils.CollectionDiscoveryUtils::completionPattern);
    }
