...
public class IncrementalSource<T, C extends SourceConfig>
    ...
    public IncrementalSourceReader<T, C> createReader(SourceReaderContext readerContext)
        ...
        BaseSourceConfig baseSourceConfig = (BaseSourceConfig) sourceConfig;
        ...
        MetricOption metricOption = MetricOption.builder()
                .withInlongLabels(baseSourceConfig.getInlongMetric())
                .withAuditAddress(baseSourceConfig.getInlongAudit())
