...
public final class DorisDynamicTableFactory implements DynamicTableSourceFactory, DynamicTableSinkFactory {
    ...
    public static final ConfigOption<String> FENODES =
            ConfigOptions.key("fenodes").stringType().noDefaultValue().withDescription("doris fe http address.");
    public static final ConfigOption<String> TABLE_IDENTIFIER =
            ConfigOptions.key("table.identifier").stringType().noDefaultValue().withDescription("the jdbc table name.");
    ...
    private static final ConfigOption<Integer> DORIS_TABLET_SIZE = ConfigOptions
            ...
            .intType()
            .defaultValue(ConfigurationOptions.DORIS_TABLET_SIZE_DEFAULT)
            .withDescription("");
    ...
    private static final ConfigOption<Integer> DORIS_DESERIALIZE_QUEUE_SIZE = ConfigOptions
            ...
            .intType()
            .defaultValue(ConfigurationOptions.DORIS_DESERIALIZE_QUEUE_SIZE_DEFAULT)
            .withDescription("");
    private static final ConfigOption<Integer> DORIS_BATCH_SIZE = ConfigOptions
            .key("doris.batch.size")
            .intType()
            .defaultValue(ConfigurationOptions.DORIS_BATCH_SIZE_DEFAULT)
            .withDescription("");
    private static final ConfigOption<Long> DORIS_EXEC_MEM_LIMIT = ConfigOptions
            .key("doris.exec.mem.limit")
            .longType()
            .defaultValue(ConfigurationOptions.DORIS_EXEC_MEM_LIMIT_DEFAULT)
            .withDescription("");
    ...
    private static final ConfigOption<Long> SINK_BUFFER_FLUSH_MAX_BYTES = ConfigOptions
            ...
            .longType()
            .defaultValue(org.apache.inlong.sort.doris.cfg.DorisExecutionOptions.DEFAULT_MAX_BATCH_BYTES)
    ...
    private org.apache.inlong.sort.doris.cfg.DorisOptions getDorisOptions(ReadableConfig readableConfig) {
        final String fenodes = readableConfig.get(FENODES);
        final org.apache.inlong.sort.doris.cfg.DorisOptions.Builder builder = DorisOptions.builder()
                .setFenodes(fenodes)
    ...
    private org.apache.inlong.sort.doris.cfg.DorisReadOptions getDorisReadOptions(ReadableConfig readableConfig) {
        final org.apache.inlong.sort.doris.cfg.DorisReadOptions.Builder builder = DorisReadOptions.builder();
    ...
    private org.apache.inlong.sort.doris.cfg.DorisExecutionOptions getDorisExecutionOptions(
            ReadableConfig readableConfig, Properties streamLoadProp) {
        final org.apache.inlong.sort.doris.cfg.DorisExecutionOptions.Builder builder = DorisExecutionOptions.builder();
