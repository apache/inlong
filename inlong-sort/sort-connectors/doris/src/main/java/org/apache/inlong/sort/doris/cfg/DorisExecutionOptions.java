...
public class DorisExecutionOptions implements Serializable {
    ...
    public DorisExecutionOptions(
            Integer batchSize, Integer maxRetries, Long batchIntervalMs,
            Properties streamLoadProp, Boolean enableDelete, Long maxBatchBytes) {
    ...
    public static class Builder {
        ...
        public DorisExecutionOptions build() {
            return new DorisExecutionOptions(
                    batchSize, maxRetries, batchIntervalMs, streamLoadProp, enableDelete, maxBatchBytes);
        }
    }
