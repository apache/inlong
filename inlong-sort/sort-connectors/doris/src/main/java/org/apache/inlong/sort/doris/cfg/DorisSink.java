...
import org.apache.inlong.sort.doris.table.DorisDynamicOutputFormat;
...
public class DorisSink {
    ...
    public static <T> SinkFunction<T> sink(
            String[] fiels, LogicalType[] types, DorisExecutionOptions executionOptions, DorisOptions dorisOptions) {
     ...
     */
    public static <T> SinkFunction<T> sink(
            DorisReadOptions readOptions, DorisExecutionOptions executionOptions, DorisOptions dorisOptions) {
     ...
     */
    public static <T> SinkFunction<T> sink(
            String[] field, LogicalType[] types, DorisReadOptions readOptions,
