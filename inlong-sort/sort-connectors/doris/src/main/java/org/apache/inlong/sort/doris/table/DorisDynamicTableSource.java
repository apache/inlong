 ...
 * or {@link SupportsProjectionPushDown}. Therefore, the main logic can be found in
 * {@link #getScanRuntimeProvider(ScanContext)}
...
public final class DorisDynamicTableSource implements ScanTableSource, LookupTableSource {
    ...
    public ScanRuntimeProvider getScanRuntimeProvider(ScanContext runtimeProviderContext) {
        ...
        org.apache.inlong.sort.doris.table.DorisRowDataInputFormat.Builder builder = DorisRowDataInputFormat.builder()
