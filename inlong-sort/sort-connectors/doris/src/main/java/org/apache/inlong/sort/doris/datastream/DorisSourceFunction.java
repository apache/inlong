...
import org.apache.inlong.sort.doris.cfg.DorisStreamOptions;
import org.apache.inlong.sort.doris.deserialization.DorisDeserializationSchema;
...
public class DorisSourceFunction extends RichParallelSourceFunction<List<?>> implements ResultTypeQueryable<List<?>> {
    ...
    private final org.apache.inlong.sort.doris.deserialization.DorisDeserializationSchema<List<?>> deserializer;
