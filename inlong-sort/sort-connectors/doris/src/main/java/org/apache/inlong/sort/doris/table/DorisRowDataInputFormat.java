...
import org.apache.inlong.sort.doris.datastream.ScalaValueReader;
import org.apache.inlong.sort.doris.rest.PartitionDefinition;
...
public class DorisRowDataInputFormat extends RichInputFormat<RowData, DorisTableInputSplit>
    ...
    public DorisRowDataInputFormat(
            DorisOptions options, List<PartitionDefinition> dorisPartitions,
            DorisReadOptions readOptions, RowType rowType) {
     ...
     * fashion</b> if this {@link InputFormat} is built using a parameterized query (i.e. using
     * a {@link PreparedStatement})
     * and a proper {@link PreparedStatement}, in a <b>non-parallel
     * fashion</b> otherwise.
     *
     ...
     */
    @Override
    public void open(org.apache.inlong.sort.doris.table.DorisTableInputSplit inputSplit) throws IOException {
