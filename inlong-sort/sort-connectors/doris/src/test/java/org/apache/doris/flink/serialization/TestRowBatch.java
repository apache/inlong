...
import org.apache.inlong.sort.doris.serialization.RowBatch;
...
public class TestRowBatch {
    ...
    public void testRowBatch() throws Exception {
        ...
        childrenBuilder.add(new Field("k1",
                FieldType.nullable(new ArrowType.Int(8, true)), null));
        childrenBuilder.add(new Field("k2",
                FieldType.nullable(new ArrowType.Int(16, true)), null));
        childrenBuilder.add(new Field("k3",
                FieldType.nullable(new ArrowType.Int(32, true)), null));
        childrenBuilder.add(new Field("k4",
                FieldType.nullable(new ArrowType.Int(64, true)), null));
        childrenBuilder.add(new Field("k9",
                FieldType.nullable(new ArrowType.FloatingPoint(FloatingPointPrecision.SINGLE)), null));
        childrenBuilder.add(new Field("k8",
        ...
        childrenBuilder.add(new Field("k5",
                FieldType.nullable(new ArrowType.Decimal(9, 2)), null));
        ...
        String schemaStr = "{\"properties\":[{\"type\":\"BOOLEAN\",\"name\":\"k0\",\"comment\":\"\"},"
            ...
            + "\"type\":\"DECIMAL\",\"precision\":\"9\",\"aggregation_type\":\"\"},"
            + "{\"type\":\"CHAR\",\"name\":\"k6\",\"comment\":\"\",\"aggregation_type\":\"REPLACE_IF_NOT_NULL\"}],"
            + "\"status\":200}";
        ...
        final List<Object> expectedRow2 = Arrays.asList(
                Boolean.FALSE,
                (byte) 2,
                (short) 2,
                null,
        ...
        final List<Object> expectedRow3 = Arrays.asList(
                Boolean.TRUE,
                (byte) 3,
                (short) 3,
                3,
    ...
    public void testBinary() throws Exception {
        final byte[] binaryRow0 = {'a', 'b', 'c'};
        final byte[] binaryRow1 = {'d', 'e', 'f'};
        final byte[] binaryRow2 = {'g', 'h', 'i'};
