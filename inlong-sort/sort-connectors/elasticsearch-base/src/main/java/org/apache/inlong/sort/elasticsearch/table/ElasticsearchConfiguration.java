...
public class ElasticsearchConfiguration {
    ...
    public Optional<Boolean> getMultipleEnable() {
        return config.getOptional(ElasticsearchOptions.SINK_MULTIPLE_ENABLE);
    }

    public Optional<SchemaUpdateExceptionPolicy> getSchemaUpdatePolicy() {
        return config.getOptional(ElasticsearchOptions.SINK_MULTIPLE_SCHEMA_UPDATE_POLICY);
    }
