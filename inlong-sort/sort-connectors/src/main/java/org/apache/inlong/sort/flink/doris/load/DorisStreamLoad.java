...
public class DorisStreamLoad implements Serializable {
    ...
    public  static final List<String> DORIS_SUCCESS_STATUS = new ArrayList<>(Arrays.asList("Success",
            "Publish Timeout"));
    ...
    public void load(String value,String streamLoadUrl) {
        ...
        if (dorisRespond.getResponseCode() != HttpStatus.SC_OK) {
            ...
            if (!DORIS_SUCCESS_STATUS.contains(dorisRespondMsg.getStatus())) {
                ...
                String errMsg = String.format("Stream load error .Reason: %s, the detail Error Msg is : [ %s ]",
                        dorisRespondMsg.getMessage(), errorMsgDetail);
