...
public class DlcWrappedHybrisCatalog extends BaseMetastoreCatalog implements SupportsNamespaces, Configurable {
    ...
    public static final String DLC_SECRET_TOKEN = "qcloud.dlc.secret-token";
    public static final String DLC_REGION = "qcloud.dlc.region";
    public static final String DLC_CREDENTIAL_PROVIDER = "qcloud.dlc.credential.provider.class";

    // cos auth
    // todo: move it to cos fileio

    public static final String LAKEFS_TOKEN_CHECKER = "lake.fs.token.checker.enable";
    public static final String LAKEFS_USER_APPID = "lake.fs.user.appid";
    public static final String LAKEFS_AUTH_URL = "lake.fs.authentication.url";
    public static final String LAKEFS_TOKEN_CACHE = "lake.fs.token.cache.enable";
    public static final String COS_CREDENTIAL_PROVIDER = "fs.cosn.credentials.provider";
    private static final String COS_ABSTRACT_FS_IMPL = "fs.AbstractFileSystem.lakefs.impl";
    private static final String COS_FS_IMPL = "fs.lakefs.impl";
    private static final String COS_REGION = "fs.cosn.bucket.region";
    ...
    public void initialize(String inputName, Map<String, String> properties) {
        ...
        // lakefs auth
        properties.entrySet().stream()
                .filter(entry -> entry.getKey().startsWith("fs") || entry.getKey().startsWith("lake.fs"))
                .forEach(entry -> this.conf.set(entry.getKey(), entry.getValue()));
