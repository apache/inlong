...
public class AvroSerializationInfoTest extends ProtocolBaseTest {
    ...
    @Override
    public void init() {
        expectedObject = new AvroSerializationInfo("testName");
        expectedJson = "{\n"
                + "  \"type\" : \"avro\",\n"
                + "  \"record_name\" : \"testName\"\n"
                + "}";

        equalObj1 = expectedObject;
        equalObj2 = new AvroSerializationInfo("testName");
        unequalObj = new AvroSerializationInfo("testName1");
    }
