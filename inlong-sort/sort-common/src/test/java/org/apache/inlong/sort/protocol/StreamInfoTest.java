...
public class StreamInfoTest {
    ...
    public void testMysqlToHiveSerialize() throws JsonProcessingException {
        ...
        String expected =
                "{\"streamId\":\"1\",\"nodes\":[{\"type\":\"mysqlExtract\",\"id\":\"1\",\"name\":\"mysql_input\","
                        + "\"fields\":[{\"type\":\"base\",\"name\":\"id\",\"formatInfo\":{\"type\":\"long\"}},"
                        + "{\"type\":\"base\",\"name\":\"name\",\"formatInfo\":{\"type\":\"string\"}},"
                        + "{\"type\":\"base\",\"name\":\"age\",\"formatInfo\":{\"type\":\"int\"}},"
                        + "{\"type\":\"base\",\"name\":\"salary\",\"formatInfo\":{\"type\":\"float\"}},"
                        + "{\"type\":\"base\",\"name\":\"ts\",\"formatInfo\":{\"type\":\"timestamp\","
                        + "\"format\":\"yyyy-MM-dd HH:mm:ss\"}}],\"watermarkField\":{\"type\":\"watermark\","
                        + "\"timeAttr\":{\"type\":\"base\",\"name\":\"ts\",\"formatInfo\":{"
                        + "\"type\":\"timestamp\",\"format\":\"yyyy-MM-dd HH:mm:ss\"}},\"interval\":{"
                        + "\"type\":\"constant\",\"value\":\"1\"},\"timeUnit\":{\"type\":\"timeUnitConstant\","
                        ...
                        + "\"outputField\":{\"type\":\"base\",\"name\":\"id\",\"formatInfo\":{\"type\":\"long\"}}},"
                        + "{\"type\":\"fieldRelationShip\",\"inputField\":{\"type\":\"base\",\"name\":\"name\","
                        + "\"formatInfo\":{\"type\":\"string\"}},\"outputField\":{\"type\":\"base\","
                        + "\"name\":\"name\",\"formatInfo\":{\"type\":\"string\"}}},"
                        + "{\"type\":\"fieldRelationShip\",\"inputField\":{\"type\":\"base\","
                        + "\"name\":\"age\",\"formatInfo\":{\"type\":\"int\"}},"
                        + "\"outputField\":{\"type\":\"base\",\"name\":\"age\",\"formatInfo\":{\"type\":\"int\"}}},"
                        + "{\"type\":\"fieldRelationShip\",\"inputField\":{\"type\":\"base\",\"name\":\"ts\","
                        + "\"formatInfo\":{\"type\":\"timestamp\",\"format\":\"yyyy-MM-dd HH:mm:ss\"}},"
                        + "\"outputField\":{\"type\":\"base\",\"name\":\"ts\",\"formatInfo\":{\"type\":\"timestamp\","
                        + "\"format\":\"yyyy-MM-dd HH:mm:ss\"}}}],\"sinkParallelism\":1,\"catalogName\":\"myHive\","
                        + "\"database\":\"default\",\"tableName\":\"test\",\"hiveConfDir\":\"/opt/hive-conf\"}],"
                        + "\"relations\":[{\"type\":\"baseRelation\",\"inputs\":[\"1\"],\"outputs\":[\"2\"]}]}";
    ...
    public void testMysqlToHiveDeserialize() throws JsonProcessingException {
        ...
        String streamInfoStr =
                "{\"streamId\":\"1\",\"nodes\":[{\"type\":\"mysqlExtract\",\"id\":\"1\",\"name\":\"mysql_input\","
                        ...
                        + "{\"type\":\"base\",\"name\":\"ts\",\"formatInfo\":{\"type\":\"timestamp\","
                        + "\"format\":\"yyyy-MM-dd HH:mm:ss\"}}],\"watermarkField\":{\"type\":\"watermark\","
                        + "\"timeAttr\":{\"type\":\"base\",\"name\":\"ts\",\"formatInfo\":{\"type\":\"timestamp\","
                        + "\"format\":\"yyyy-MM-dd HH:mm:ss\"}},\"interval\":{\"type\":\"constant\",\"value\":\"1\"},"
                        + "\"timeUnit\":{\"type\":\"timeUnitConstant\",\"timeUnit\":\"MINUTE\",\"value\":\"MINUTE\"}},"
                        + "\"primaryKey\":\"id\",\"tableNames\":[\"table\"],\"hostname\":\"localhost\",\"username\":"
                        + "\"username\",\"password\":\"username\",\"database\":\"test_database\",\"port\":3306,"
                        + "\"serverId\":123,\"incrementalSnapshotEnabled\":true},"
                        + "{\"type\":\"hiveLoad\",\"id\":\"2\",\"name\":\"hive_output\","
                        + "\"fields\":[{\"type\":\"base\",\"name\":\"id\",\"formatInfo\":{\"type\":\"long\"}},"
                        + "{\"type\":\"base\",\"name\":\"name\",\"formatInfo\":{\"type\":\"string\"}},"
                        + "{\"type\":\"base\",\"name\":\"age\",\"formatInfo\":{\"type\":\"int\"}},"
                        + "{\"type\":\"base\",\"name\":\"salary\",\"formatInfo\":{\"type\":\"float\"}},"
                        + "{\"type\":\"base\",\"name\":\"ts\",\"formatInfo\":{\"type\":\"timestamp\",\"format\":"
                        + "\"yyyy-MM-dd HH:mm:ss\"}}],\"fieldRelationShips\":[{\"type\":\"fieldRelationShip\","
                        + "\"inputField\":{\"type\":\"base\",\"name\":\"id\",\"formatInfo\":{\"type\":\"long\"}},"
                        + "\"outputField\":{\"type\":\"base\",\"name\":\"id\",\"formatInfo\":{\"type\":\"long\"}}},"
                        + "{\"type\":\"fieldRelationShip\",\"inputField\":{\"type\":\"base\",\"name\":\"name\","
                        + "\"formatInfo\":{\"type\":\"string\"}},\"outputField\":{\"type\":\"base\",\"name\":\"name\","
                        + "\"formatInfo\":{\"type\":\"string\"}}},{\"type\":\"fieldRelationShip\",\"inputField\":{"
                        + "\"type\":\"base\",\"name\":\"age\",\"formatInfo\":{\"type\":\"int\"}},"
                        + "\"outputField\":{\"type\":\"base\",\"name\":\"age\",\"formatInfo\":{\"type\":\"int\"}}},"
                        + "{\"type\":\"fieldRelationShip\",\"inputField\":{\"type\":\"base\",\"name\":\"ts\","
                        + "\"formatInfo\":{\"type\":\"timestamp\",\"format\":\"yyyy-MM-dd HH:mm:ss\"}},"
