...
public abstract class JoinRelation extends NodeRelation {
    ...
    public JoinRelation(
        ...
        this.joinConditionMap =
                Preconditions.checkNotNull(joinConditionMap, "joinConditionMap is null");
        Preconditions.checkState(!joinConditionMap.isEmpty(), "joinConditionMap is empty");
    }

    /**
     * Node relation format that is, the relation is converted into a string representation of SQL
     *
