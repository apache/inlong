...
import static org.apache.inlong.sort.protocol.constant.PaimonConstant.*;

/**
 * Paimon extract node for extract data from paimon
 */
@EqualsAndHashCode(callSuper = true)
@JsonTypeName("paimonExtract")
@JsonInclude(Include.NON_NULL)
@Data
public class PaimonExtractNode extends ExtractNode implements Serializable {
    ...
    public String genTableName() {
        return String.format("paimon_table_%s", getId());
    }
}
