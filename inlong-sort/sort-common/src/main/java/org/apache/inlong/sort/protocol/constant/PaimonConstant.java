...
public class PaimonConstant {
    ...
    /**
     * 'connector' = 'paimon-inlong'
     */
    public static final String CONNECTOR = "paimon-inlong";
     ...
     */
    public static final String PAIMON_OPTION_HIVE_SYNC_ENABLED = "hive_sync.enabled";

    /**
     * Database name for hive sync, default 'default'
     */
    public static final String PAIMON_OPTION_HIVE_SYNC_DB = "hive_sync.db";

    /**
     * Table name for hive sync, default 'unknown'
     */
    public static final String PAIMON_OPTION_HIVE_SYNC_TABLE = "hive_sync.table";

    /**
     * File format for hive sync, default 'PARQUET'
     */
    public static final String PAIMON_OPTION_HIVE_SYNC_FILE_FORMAT = "hive_sync.file_format";

    /**
     * Mode to choose for Hive ops. Valid values are hms, jdbc and hiveql, default 'hms'
     */
    public static final String PAIMON_OPTION_HIVE_SYNC_MODE = "hive_sync.mode";

    /**
     * The HMS mode use the hive meta client to sync metadata.
     */
    public static final String PAIMON_OPTION_HIVE_SYNC_MODE_HMS_VALUE = "hms";

    /**
     * Metastore uris for hive sync, default ''
     */
    public static final String PAIMON_OPTION_HIVE_SYNC_METASTORE_URIS = "hive_sync.metastore.uris";

    /**
     * Base path for the target paimon table.
     * The path would be created if it does not exist,
     * otherwise a Hoodie table expects to be initialized successfully
     */
    public static final String PAIMON_OPTION_DEFAULT_PATH = "path";
     ...
     */
    public static final String PAIMON_OPTION_DATABASE_NAME = "paimon.database.name";

    /**
     * Table name that will be used for registering with Hive. Needs to be same across runs.
     */
    public static final String PAIMON_OPTION_TABLE_NAME = "paimon.table.name";
     ...
     */
    public static final String PAIMON_OPTION_RECORD_KEY_FIELD_NAME = "paimon.datasource.write.recordkey.field";
     ...
     */
    public static final String PAIMON_OPTION_PARTITION_PATH_FIELD_NAME = "paimon.datasource.write.partitionpath.field";
