...
public class InLongMsgPbOptions {
    ...
    public static final ConfigOption<String> INNER_FORMAT = ConfigOptions.key("inner.format")
            .stringType()
            .noDefaultValue()
    ...
    public static final ConfigOption<String> DECOMPRESS_TYPE = ConfigOptions.key("decompress.type")
            .stringType()
            .defaultValue("gzip")
