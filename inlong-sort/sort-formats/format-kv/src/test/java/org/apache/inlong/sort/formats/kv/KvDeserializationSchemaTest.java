...
public class KvDeserializationSchemaTest {
    ...
    public void testNormal() throws Exception {
        ...
        testBasicDeserialization(
                config, DoubleFormatInfo.INSTANCE, 0.33333333332, "f=0.33333333332");
        testBasicDeserialization(
                config,
        ...
        testBasicDeserialization(
                ...
                "f=22/03/2020");
        testBasicDeserialization(
                config, new TimeFormatInfo("ss/mm/hh"), Time.valueOf("11:12:13"), "f=13/12/11");
        testBasicDeserialization(
                config,
                new TimestampFormatInfo("dd/MM/yyyy hh:mm:ss"),
                Timestamp.valueOf("2020-03-22 11:12:13"),
                "f=22/03/2020 11:12:13");
    }
    ...
    public void testNullIteral() throws Exception {
        ...
        testBasicDeserialization(
                config, new TimestampFormatInfo("dd/MM/yyyy hh:mm:ss"), null, nullField);
    }
    ...
    public void testDelimiter() throws Exception {
        ...
        testRowDeserialization(
                config, Row.of(10, "aa", "bb", "cc"), "f1,10|f2,aa|f3,bb|f4,cc".getBytes());
    }
    ...
    public void testMissingField() throws Exception {
        ...
        testRowDeserialization(
                config, Row.of(null, "aa", "bb", "cc"), "f2=aa&f3=bb&f4=cc".getBytes());
    }
    ...
    public void testExtraField() throws Exception {
        ...
        testRowDeserialization(
                config, Row.of(10, "aa", "bb", "cc"), "f1=10&f2=aa&f3=bb&f4=cc&f5=dd".getBytes());
    }
    ...
    private void testRowDeserialization(
            Consumer<KvDeserializationSchema.Builder> config, Row expectedRow, byte[] bytes)
            throws Exception {
        KvDeserializationSchema.Builder builder =
