...
public class InLongMsgRowDataSerDeTest {
    ...
    public void testDeserializeInLongMsg() throws Exception {
        ...
        inLongMsg1.addMsg(
                "streamId=HAHA&t=202201011112", "1,asdqw".getBytes(StandardCharsets.UTF_8));
        inLongMsg1.addMsg(
                "streamId=xixi&t=202201011112", "2,testData".getBytes(StandardCharsets.UTF_8));
        InLongMsg inLongMsg2 = InLongMsg.newInLongMsg();
        inLongMsg1.addMsg(
                "streamId=oooo&t=202201011112", "3,dwqdqw".getBytes(StandardCharsets.UTF_8));
        inLongMsg1.addMsg(
                "streamId=bubub&t=202201011112", "4,asdqdqwe".getBytes(StandardCharsets.UTF_8));
        List<InLongMsg> inLongMsgs = Stream.of(inLongMsg1).collect(Collectors.toList());
        List<byte[]> input =
                inLongMsgs.stream()
                        .map(inLongMsg -> inLongMsg.buildArray())
                        .collect(Collectors.toList());
        final List<RowData> exceptedOutput =
                Stream.of(
        ...
        final Map<String, String> tableOptions =
                InLongMsgFormatFactoryTest.getModifiedOptions(
                        opts -> {
    ...
    public void testDeserializeInLongMsgWithError() throws Exception {
        // mock data
        InLongMsg inLongMsg1 = InLongMsg.newInLongMsg();
        inLongMsg1.addMsg("asdq", "1, asd".getBytes(StandardCharsets.UTF_8));
        List<InLongMsg> inLongMsgs = Stream.of(inLongMsg1).collect(Collectors.toList());
        List<byte[]> input =
                inLongMsgs.stream()
                        .map(inLongMsg -> inLongMsg.buildArray())
    ...
    public void testDeserializeInLongMsgWithMetadata() throws Exception {
        InLongMsg inLongMsg1 = InLongMsg.newInLongMsg();
        inLongMsg1.addMsg(
                "streamId=HAHA&dt=1652153467000", "1,asdqw".getBytes(StandardCharsets.UTF_8));
        inLongMsg1.addMsg(
                "streamId=xixi&dt=1652153467000", "2,testData".getBytes(StandardCharsets.UTF_8));
        InLongMsg inLongMsg2 = InLongMsg.newInLongMsg();
        inLongMsg1.addMsg(
                "streamId=oooo&dt=1652153468000", "3,dwqdqw".getBytes(StandardCharsets.UTF_8));
        inLongMsg1.addMsg(
                "streamId=bubub&dt=1652153469000", "4,asdqdqwe".getBytes(StandardCharsets.UTF_8));
        List<InLongMsg> inLongMsgs = Stream.of(inLongMsg1).collect(Collectors.toList());
        List<byte[]> input =
                inLongMsgs.stream()
                        .map(inLongMsg -> inLongMsg.buildArray())
        ...
        final List<RowData> exceptedOutput =
                Stream.of(
                                GenericRowData.of(
                                        1L,
                                        BinaryStringData.fromString("asdqw"),
                                        TimestampData.fromTimestamp(new Timestamp(1652153467000L))),
                                GenericRowData.of(
                                        2L,
                                        BinaryStringData.fromString("testData"),
                                        TimestampData.fromTimestamp(new Timestamp(1652153467000L))),
                                GenericRowData.of(
                                        3L,
                                        BinaryStringData.fromString("dwqdqw"),
                                        TimestampData.fromTimestamp(new Timestamp(1652153468000L))),
                                GenericRowData.of(
                                        4L,
                                        BinaryStringData.fromString("asdqdqwe"),
        ...
        DecodingFormat<DeserializationSchema<RowData>> decodingFormat =
                factory.createDecodingFormat(
                        FactoryMocks.createTableContext(schema, tableOptions),
