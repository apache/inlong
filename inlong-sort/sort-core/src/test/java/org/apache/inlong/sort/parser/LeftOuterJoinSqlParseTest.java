...
public class LeftOuterJoinSqlParseTest extends AbstractTestBase {
    ...
    /**
     * Test left outer join The use case is that three input nodes generate a transformation node
     * through left outer join, and then another transformation node is synchronized to the output
     * node
     *
    ...
    public void testLeftOuterJoin() throws Exception {
        ...
        StreamInfo streamInfo =
                new StreamInfo(
                        ...
                        Arrays.asList(
                                buildLeftOuterJoinNodeRelation(
    ...
    /**
     * Test left outer join with distinct and filter The same as {@link #testLeftOuterJoin()} , it's
     * just the difference that the transform node is {@link DistinctNode} and have filters
     *
     * @throws Exception The exception may throws when executing
