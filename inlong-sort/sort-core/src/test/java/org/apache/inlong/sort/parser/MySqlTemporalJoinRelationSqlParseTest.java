...
public class MySqlTemporalJoinRelationSqlParseTest extends AbstractTestBase {
    ...
    private MySqlExtractNode buildMySQLExtractNode() {
        List<FieldInfo> fields =
                Arrays.asList(
                        new FieldInfo("currency", new LongFormatInfo()),
        ...
        return new MySqlExtractNode(
                ...
                map,
                "currency",
                Collections.singletonList("currency_rates"),
                "localhost",
                "inlong",
                "inlong",
                "inlong",
    ...
    private TemporalJoinRelation buildNodeRelation(
            List<Node> inputs, List<Node> outputs, boolean left, FieldInfo systemTime) {
    ...
    public void testInnerTemporalJoinWithEventTimeParse() throws Exception {
        ...
        StreamInfo streamInfo =
                new StreamInfo(
                        ...
                        Collections.singletonList(
                                buildNodeRelation(
                                        Arrays.asList(kafkaExtractNode, mySqlExtractNode2),
                                        Collections.singletonList(kafkaLoadNode),
                                        false,
                                        new FieldInfo("order_time"))));
    ...
    /**
     * Test left temporal join with event time for extract is mysql {@link MySqlExtractNode}, {@link
     * KafkaExtractNode} and load is mysql {@link KafkaLoadNode}
     *
     * @throws Exception The exception may be thrown when executing
     */
    @Test
