...
public class InnerJoinRelationSqlParseTest extends AbstractTestBase {
        ...
        List<FieldRelation> relations =
                Arrays.asList(
                        ...
                        new FieldRelation(
                                ...
                                new FieldInfo("ts", new TimestampFormatInfo())),
                        new FieldRelation(
                                new FieldInfo("salary", "3", new TimestampFormatInfo()),
    ...
    /**
     * Test innser join The use case is that three input nodes generate a transformation node
     * through inner join, and then another transformation node is synchronized to the output node
     *
    ...
    public void testInnerJoin() throws Exception {
        ...
        StreamInfo streamInfo =
                new StreamInfo(
                        ...
                        Arrays.asList(
                                buildInnerJoinNodeRelation(
                                        Arrays.asList(inputNode, inputNode2, inputNode3),
    ...
    /**
     * Test inner join with upsert kafka The same as {@link #testInnerJoin()} , it's just the
     * difference that the output node is upsert-kafka
     *
     * @throws Exception The exception may throws when executing
     * @see #testInnerJoin()
     */
    ...
    /**
     * Test inner join with distinct and filter The same as {@link #testInnerJoinWithUpsertKafka()}
