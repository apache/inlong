...
public class FullOuterJoinSqlParseTest extends AbstractTestBase {
    ...
    /**
     * Test full outer join The use case is that three input nodes generate a transformation node
     * through full outer join, and then another transformation node is synchronized to the output
     * node
     *
    ...
    /**
     * Test full outer join with distinct and filter The same as {@link #testFullOuterJoin()} , it's
