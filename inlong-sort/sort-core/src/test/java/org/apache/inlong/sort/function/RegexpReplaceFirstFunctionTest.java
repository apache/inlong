...
/**
 * Test for {@link RegexpReplaceFirstFunction} and {@link
...
public class RegexpReplaceFirstFunctionTest extends AbstractTestBase {
    ...
    public void testRegexpReplaceFirst() throws Exception {
        ...
        data.add(
                Row.of(
                        "inlong is a data integration tool and inlong has been used by many companies"));
        ...
        String sqlQuery =
                String.format(
                        "SELECT %s as f1 FROM temp_view", regexpReplaceFirstFunction.format());
