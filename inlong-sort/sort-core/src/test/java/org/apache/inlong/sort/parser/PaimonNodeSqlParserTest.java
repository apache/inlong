...
/**
 * Test for Paimon SQL parser.
 */
public class PaimonNodeSqlParserTest extends AbstractTestBase {
    ...
    private PaimonLoadNode buildPaimonLoadNodeWithHadoopCatalog() {
        List<FieldInfo> fields = Arrays.asList(new FieldInfo("id", new LongFormatInfo()),
                new FieldInfo("name", new StringFormatInfo()),
        ...
        return new PaimonLoadNode(
                ...
                CatalogType.HADOOP,
                null,
                "hdfs://localhost:9000/paimon/warehouse",
                extList,
                "f1");
    }

    private PaimonLoadNode buildPaimonLoadNodeWithHiveCatalog() {
        List<FieldInfo> fields = Arrays.asList(new FieldInfo("id", new LongFormatInfo()),
                new FieldInfo("name", new StringFormatInfo()),
                new FieldInfo("age", new IntFormatInfo()),
                new FieldInfo("ts", new TimestampFormatInfo()));
    ...
    @Test
    public void testPaimon() throws Exception {
        ...
        Node outputNode = buildPaimonLoadNodeWithHiveCatalog();
