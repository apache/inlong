...
public class CustomFunctionSqlParseTest extends AbstractTestBase {
    ...
    private MySqlExtractNode buildMySQLExtractNode() {
        ...
        return new MySqlExtractNode(
                ...
                map,
                "id",
                Collections.singletonList("table_input"),
                "localhost",
                "inlong",
                "inlong",
                "inlong",
    ...
    private List<FieldRelation> buildFieldRelationByCustomFunction() {
        return Arrays.asList(
                new FieldRelation(
                        ...
                        new FieldInfo("id", new LongFormatInfo())),
                new FieldRelation(
                        new CustomFunction("`name`"),
                        new FieldInfo("name", new StringFormatInfo())),
                new FieldRelation(
                        new CustomFunction("ABS(age)"), new FieldInfo("age", new IntFormatInfo())));
    }
    ...
    /**
     * Test flink sql task for extract is mysql {@link MySqlExtractNode} and load is mysql {@link
     * MySqlLoadNode}
     *
