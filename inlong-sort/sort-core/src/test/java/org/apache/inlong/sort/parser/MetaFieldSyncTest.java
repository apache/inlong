...
public class MetaFieldSyncTest extends AbstractTestBase {
    ...
    /**
     * Test meta field sync test It contains mysql cdc to kafka canal-json, kafka canal-json to
     * kafka canal-json test
     *
    ...
    public void testMetaFieldSyncTest() throws Exception {
        ...
        StreamInfo streamInfo =
                new StreamInfo(
                        "1",
                        Arrays.asList(
                                mysqlInputNode, kafkaInputNode, kafkaOutputNode, kafkaOutputNode2),
                        Arrays.asList(
                                buildNodeRelation(
                                        Collections.singletonList(mysqlInputNode),
                                        Collections.singletonList(kafkaOutputNode)),
                                buildNodeRelation(
                                        Collections.singletonList(kafkaInputNode),
