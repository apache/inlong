...
public class MySqlExtractNodeToDorisLoadNodeTest extends AbstractTestBase {
    ...
    private DorisLoadNode buildDorisLoadNode() {
        ...
        final List<FieldRelation> fieldRelations =
                Arrays.asList(
                        new FieldRelation(
                                new FieldInfo("id", new IntFormatInfo()),
                                new FieldInfo("id", new IntFormatInfo())),
        ...
        // Support delete event (sink.enable-delete='true'), requires Doris table to enable batch
        // delete function
        Map<String, String> map = new HashMap<>();
    ...
    /**
     * Test flink sql task for extract is mysql {@link MySqlExtractNode} and load is doris {@link
     * DorisLoadNode}
     */
    @Test
