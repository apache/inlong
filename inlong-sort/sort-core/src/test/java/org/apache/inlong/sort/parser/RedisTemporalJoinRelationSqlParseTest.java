...
public class RedisTemporalJoinRelationSqlParseTest extends AbstractTestBase {
    ...
    private Node buildRedisExtractNode(String id, RedisCommand redisCommand, String additionalKey) {
        List<FieldInfo> fields =
                Arrays.asList(
                        new FieldInfo("k", new StringFormatInfo()),
        ...
        List<FieldRelation> relations =
                Arrays.asList(
                        ...
                        new FieldRelation(
                                ...
                                new FieldInfo("name", new StringFormatInfo())),
                        new FieldRelation(
                                new FieldInfo("age", "1", new IntFormatInfo()),
                                new FieldInfo("age", new IntFormatInfo())),
                        new FieldRelation(
                                new FieldInfo("v", "2", new StringFormatInfo()),
                                new FieldInfo("nickname", new StringFormatInfo())),
                        new FieldRelation(
                                new FieldInfo("v", "3", new LongFormatInfo()),
                                new FieldInfo("rank", new LongFormatInfo())),
                        new FieldRelation(
                                new FieldInfo("v", "4", new DoubleFormatInfo()),
                                new FieldInfo("score", new DoubleFormatInfo())),
                        new FieldRelation(
                                new FieldInfo("v", "5", new StringFormatInfo()),
     ...
     */
    private TemporalJoinRelation buildNodeRelation(
            List<Node> inputs, List<Node> outputs, boolean left) {
        ...
        conditionMap.put(
                ...
                Collections.singletonList(
                        new SingleValueFilterFunction(
                                ...
                                new FieldInfo("k", "2", new StringFormatInfo()))));
        conditionMap.put(
                "3",
                Collections.singletonList(
                        new SingleValueFilterFunction(
                                ...
                                new FieldInfo("id", "1", new StringFormatInfo()),
                                EqualOperator.getInstance(),
                                new FieldInfo("k", "3", new StringFormatInfo()))));
        conditionMap.put(
                "4",
                Collections.singletonList(
                        new SingleValueFilterFunction(
                                ...
                                new FieldInfo("id", "1", new LongFormatInfo()),
                                EqualOperator.getInstance(),
                                new FieldInfo("k", "4", new StringFormatInfo()))));
        conditionMap.put(
                "5",
                Collections.singletonList(
                        new SingleValueFilterFunction(
                                ...
                                new FieldInfo("id", "1", new LongFormatInfo()),
                                EqualOperator.getInstance(),
                                new FieldInfo("k", "5", new StringFormatInfo()))));
        if (left) {
            return new LeftOuterTemporalJoinRelation(
                    inputIds, outputIds, conditionMap, new FieldInfo("proc_time"));
        }
    ...
    /**
     * Test left temporal join for extract is mysql {@link MySqlExtractNode}, {@link
     * RedisExtractNode} and load is mysql {@link MySqlLoadNode}
     *
    ...
    public void testLeftTemporalJoinParse() throws Exception {
        ...
        StreamInfo streamInfo =
                new StreamInfo(
                        "1",
                        Arrays.asList(
                                inputNode, redisDim1, redisDim2, redisDim3, redisDim4, outputNode),
                        Collections.singletonList(
                                buildNodeRelation(
                                        Arrays.asList(
                                                inputNode, redisDim1, redisDim2, redisDim3,
                                                redisDim4),
    ...
    /**
     * Test inner temporal join for extract is mysql {@link MySqlExtractNode}, {@link
     * RedisExtractNode} and load is mysql {@link MySqlLoadNode}
     *
     * @throws Exception The exception may be thrown when executing
     */
