...
public class RightOuterJoinSqlParseTest extends AbstractTestBase {
    ...
    /**
     * Test right outer join The use case is that three input nodes generate a transformation node
     * through right outer join, and then another transformation node is synchronized to the output
     * node
     *
    ...
    public void testRightOuterJoin() throws Exception {
        ...
        StreamInfo streamInfo =
                new StreamInfo(
                        ...
                        Arrays.asList(
                                buildRightOuterJoinNodeRelation(
    ...
    /**
     * Test right outer join with distinct and filter The same as {@link #testRightOuterJoin()} ,
