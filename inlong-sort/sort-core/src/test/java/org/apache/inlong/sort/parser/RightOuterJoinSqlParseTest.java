...
public class RightOuterJoinSqlParseTest extends AbstractTestBase {
    ...
    /**
     * Test right outer join The use case is that three input nodes generate a
     * transformation node through right outer join, and then another transformation
     * node is synchronized to the output node
     *
     * @throws Exception
    ...
    /**
     * Test right outer join with distinct and filter The same as
     * {@link #testRightOuterJoin()} , it's just the difference that the transform
     * node is {@link DistinctNode} and have filters
     *
     * @throws Exception
     *           The exception may throws when executing
