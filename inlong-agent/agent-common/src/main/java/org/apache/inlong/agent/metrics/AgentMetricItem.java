...
public class AgentMetricItem extends MetricItem {
    ...
    @Dimension public String pluginId;
    @Dimension public String inlongGroupId;
    @Dimension public String inlongStreamId;

    @CountMetric public AtomicLong jobRunningCount = new AtomicLong(0);
    @CountMetric public AtomicLong jobFatalCount = new AtomicLong(0);
    @CountMetric public AtomicLong taskRunningCount = new AtomicLong(0);
    @CountMetric public AtomicLong taskRetryingCount = new AtomicLong(0);
    @CountMetric public AtomicLong taskFatalCount = new AtomicLong(0);
    @CountMetric public AtomicLong sinkSuccessCount = new AtomicLong(0);
    @CountMetric public AtomicLong sinkFailCount = new AtomicLong(0);
    @CountMetric public AtomicLong sourceSuccessCount = new AtomicLong(0);
    @CountMetric public AtomicLong sourceFailCount = new AtomicLong(0);
    @CountMetric public AtomicLong pluginReadCount = new AtomicLong(0);
    @CountMetric public AtomicLong pluginSendCount = new AtomicLong(0);
    @CountMetric public AtomicLong pluginReadFailCount = new AtomicLong(0);
    @CountMetric public AtomicLong pluginSendFailCount = new AtomicLong(0);
    @CountMetric public AtomicLong pluginReadSuccessCount = new AtomicLong(0);
    @CountMetric public AtomicLong pluginSendSuccessCount = new AtomicLong(0);
}
