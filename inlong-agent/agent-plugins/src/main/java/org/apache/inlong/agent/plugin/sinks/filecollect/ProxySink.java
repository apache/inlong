...
public class ProxySink extends AbstractSink {
    ...
    public static final int WRITE_FAILED_SLEEP_TIME_MS = 10;
    public static final int DESTROY_WAIT_SLEEP_TIME_MS = 10;
    ...
    public void write(Message message) {
        ...
        while (!suc) {
            ...
            if (!suc) {
                AgentUtils.silenceSleepInMs(WRITE_FAILED_SLEEP_TIME_MS);
            }
        }
    }
    ...
    public void destroy() {
        ...
        shutdown = true;
        while (running) {
            AgentUtils.silenceSleepInMs(DESTROY_WAIT_SLEEP_TIME_MS);
        }
