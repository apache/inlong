...
public class TestBinlogReader {
    ...
    public void binlogStartSpacialTest() throws Exception {
        ...
        jobProfile.set(BinlogReader.JOB_DATABASE_OFFSET_SPECIFIC_OFFSET_POS, "612");
        // jobProfile.set(BinlogReader.JOB_DATABASE_SNAPSHOT_MODE, "initial");
        jobProfile.set(BinlogReader.JOB_DATABASE_SNAPSHOT_MODE, "schema_only_recovery");
        jobProfile.set("job.instance.id", "instance_id");
