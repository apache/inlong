...
public class TestTriggerManager {
    ...
    public void testRestartTriggerJobRestore() throws Exception {
        ...
        System.out.println("testRestartTriggerJobRestore 1 task size " + agent.getManager().getTaskManager().getTaskSize());
        await().atMost(10, TimeUnit.SECONDS).until(() -> agent.getManager().getTaskManager().getTaskSize() == 1);
        System.out.println("testRestartTriggerJobRestore 2 task size " + agent.getManager().getTaskManager().getTaskSize());
        agent.restart();
        System.out.println("testRestartTriggerJobRestore 3 task size " + agent.getManager().getTaskManager().getTaskSize());
        await().atMost(10, TimeUnit.SECONDS).until(() -> agent.getManager().getTaskManager().getTaskSize() == 1);
        System.out.println("testRestartTriggerJobRestore 4 task size " + agent.getManager().getTaskManager().getTaskSize());
        // cleanup
