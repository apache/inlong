...
public class OffsetManager extends AbstractDaemon {
    ...
    private OffsetManager(
            OffsetStore taskBasicOffsetStore, OffsetStore instanceBasicOffsetStore,
            OffsetStore offsetBasicOffsetStore) {
        taskDb = new TaskDb(taskBasicOffsetStore);
        instanceDb = new InstanceDb(instanceBasicOffsetStore);
        offsetDb = new OffsetDb(offsetBasicOffsetStore);
    }
    ...
    public static void init(
        ...
        if (offsetManager == null) {
            synchronized (OffsetManager.class) {
                if (offsetManager == null) {
                    offsetManager = new OffsetManager(taskBasicOffsetStore, instanceBasicOffsetStore,
    ...
    private void cleanDbInstance() {
        ...
        Iterator<InstanceProfile> iterator = instanceDb.listAllInstances().listIterator();
