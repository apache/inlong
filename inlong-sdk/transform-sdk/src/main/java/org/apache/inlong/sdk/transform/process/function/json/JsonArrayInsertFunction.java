...
@TransformFunction(type = FunctionConstant.JSON_TYPE, names = {
        "json_array_insert"}, parameter = "(String json_doc, String path1, String val1[, String path2, String val2, ...] )", descriptions = {
                "- Return \"\" if any argument is NULL;", "- Return the 'json_doc' inserted into the array.",
                "Note: If multiple groups of parameters are passed in, the parameter subscripts of the latter groups need to be based on the document subscripts after the previous group of parameters are updated."}, examples = {
