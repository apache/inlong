 ...
 */
@TransformFunction(type = FunctionConstant.TEMPORAL_TYPE, names = {"from_unix_time",
        "form_unixtime"}, parameter = "(Numeric numeric,String formatStr)", descriptions = {
                "- Return \"\" if 'numeric' is NULL;",
                "- Return a representation of the numeric argument as a value in string.",
                "Note: 'formatStr' defaults to 'yyyy-MM-dd HH:mm:ss'. numeric is an internal timestamp value representing seconds since ‘1970-01-01 00:00:00’ UTC, such as produced by the UNIX_TIMESTAMP() function."}, examples = {
