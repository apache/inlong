 ...
 * description: test the ucase function in transform processor
 */
public class TestUcaseFunction extends AbstractFunctionStringTestBase {

    @Test
    public void testUcaseFunction() throws Exception {
        String transformSql1 = "select ucase(string1) from source";
        ...
        // case3: ucase(null)
        String transformSql2 = "select ucase(xxd) from source";
