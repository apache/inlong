...
public class TestAcosdFunction extends AbstractFunctionArithmeticTestBase {

    @Test
    public void testAcosdFunction() throws Exception {
        String transformSql = "select acosd(numeric1) from source";
