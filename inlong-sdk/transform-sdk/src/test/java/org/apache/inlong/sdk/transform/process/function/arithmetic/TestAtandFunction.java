...
public class TestAtandFunction extends AbstractFunctionArithmeticTestBase {

    @Test
    public void testAtandFunction() throws Exception {
        String transformSql = "select atand(numeric1) from source";
        ...
        Assert.assertEquals(output3.get(0), "result=-45.0");
    }
}
