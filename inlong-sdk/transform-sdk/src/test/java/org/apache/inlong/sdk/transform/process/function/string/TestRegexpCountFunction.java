...
public class TestRegexpCountFunction extends AbstractFunctionStringTestBase {
    ...
    public void testRegexpCountFunction() throws Exception {
        String transformSql1 = "select regexp_count(string1,string2) from source";
        ...
        List<String> output2 = processor1.transform("The quick brown fox quick|slow|2|1|3", new HashMap<>());
