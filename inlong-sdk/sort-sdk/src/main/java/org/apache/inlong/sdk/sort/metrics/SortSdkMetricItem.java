...
public class SortSdkMetricItem extends MetricItem {
    ...
    @Dimension public String sortTaskId;
    @Dimension public String clusterId;
    @Dimension public String topic;
    @Dimension public String partitionId;

    @CountMetric public AtomicLong consumeSize = new AtomicLong(0);
    @CountMetric public AtomicLong consumeMsgCount = new AtomicLong(0);
    @CountMetric public AtomicLong callbackCount = new AtomicLong(0);
    @CountMetric public AtomicLong callbackDoneCount = new AtomicLong(0);
    @CountMetric public AtomicLong callbackTimeCost = new AtomicLong(0);
    @CountMetric public AtomicLong callbackFailCount = new AtomicLong(0);
    @CountMetric public AtomicLong topicOnlineCount = new AtomicLong(0);
    @CountMetric public AtomicLong topicOfflineCount = new AtomicLong(0);
    @CountMetric public AtomicLong ackFailCount = new AtomicLong(0);
    @CountMetric public AtomicLong ackSuccCount = new AtomicLong(0);
    @CountMetric public AtomicLong requestManagerCount = new AtomicLong(0);
    @CountMetric public AtomicLong requestManagerTimeCost = new AtomicLong(0);
    @CountMetric public AtomicLong requestManagerFailCount = new AtomicLong(0);
    @CountMetric public AtomicLong requestManagerConfChangedCount = new AtomicLong(0);
    @CountMetric public AtomicLong requestManagerCommonErrorCount = new AtomicLong(0);
    @CountMetric public AtomicLong requestManagerParamErrorCount = new AtomicLong(0);
