...
public interface TopicFetcherBuilder {
    ...
    /**
     * Specify the interceptor of TopicFetcher. The interceptor is used to filter or
     * modify the message fetched from MQ. The default interceptor is
    ...
    /**
     * Specify the topic to be subscribed. Repeated call will replace the previous
     * topic.
     *
     * @param topic
    ...
    /**
     * Specify the topics to be subscribed. Repeated call will replace the previous
     * topics.
     * <p>
     * This method will removed the topic which is added though
     * TopicFetcherBuilder::topic(InLongTopic topic)
     * </p>
     *
     * @param topics
    ...
    /**
     * Specify the deserializer of fetcher. Deserializer is used to decode the
     * messages fetched from MQ, and arrange them to {@link InLongMessage} format.
