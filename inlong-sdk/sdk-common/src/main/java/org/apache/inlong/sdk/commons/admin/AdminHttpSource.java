...
public class AdminHttpSource extends SslContextAwareAbstractSource
    ...
    public void configure(Context context) {
        ...
        try {
            ...
            Preconditions.checkState(
                    host != null && !host.isEmpty(), "HTTPSource hostname specified is empty");
            Preconditions.checkNotNull(
                    port, "HTTPSource requires a port number to be" + " specified");
            ...
            Class<? extends AdminHttpSourceHandler> clazz =
                    (Class<? extends AdminHttpSourceHandler>) Class.forName(handlerClassName);
    ...
    public void start() {
        Preconditions.checkState(
                srv == null,
                "Running HTTP Server found in source: "
                        + getName()
                ...
                getSslContextSupplier()
                        ...
                        .map(
                                sslContext -> {
                                    ...
                                    sslCtxFactory.setExcludeProtocols(
                                            getExcludeProtocols().toArray(new String[] {}));
                                    sslCtxFactory.setIncludeProtocols(
                                            getIncludeProtocols().toArray(new String[] {}));
                                    ...
                                    FlumeBeanConfigurator.setConfigurationFields(
                                            sslCtxFactory, sourceContext);
                        ...
                        .orElse(
                                new ServerConnector(
                                        srv, new HttpConnectionFactory(httpConfiguration)));
